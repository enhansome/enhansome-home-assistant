...
please read the [guide](https://github.com/frenck/awesome-home-assistant/blob/main/.github/CONTRIBUTING.md) ⭐ 8,435 | 🐛 22 | 🌐 Python | 📅 2026-09-11
or raise an [issue](https://github.com/frenck/awesome-home-assistant/issues/new/choose) ⭐ 8,435 | 🐛 22 | 🌐 Python | 📅 2026-09-11
...
* [Frigate Discussions](https://github.com/blakeblackshear/frigate/discussions) ⭐ 35,774 | 🐛 161 | 🌐 TypeScript | 📅 2026-09-11 - GitHub Discussions for the local-NVR / object-detection project.
* [Zigbee2MQTT Discussions](https://github.com/Koenkk/zigbee2mqtt/discussions) ⭐ 15,628 | 🐛 458 | 🌐 TypeScript | 📅 2026-09-11 - GitHub Discussions for the popular Zigbee bridge.
...
* [LLM Vision](https://github.com/valentinfrlch/ha-llmvision) ⭐ 1,467 | 🐛 40 | 🌐 Python | 📅 2026-09-05 - Add visual intelligence to your automations: caption camera snapshots, summarize what is happening, react to specific events (1,373★).
...
* [Adaptive Lighting](https://github.com/basnijholt/adaptive-lighting) ⭐ 3,463 | 🐛 143 | 🌐 Python | 📅 2026-09-10 - Slowly adjust the brightness and color temperature of your lights based on the position of the sun (3,324★).
...
* [Better Thermostat](https://github.com/KartoffelToby/better_thermostat) ⭐ 1,480 | 🐛 62 | 🌐 Python | 📅 2026-09-11 - Smarter thermostat with window detection, heating curves, and per-room comfort profiles for thermostatic radiator valves (1,443★).
* [Versatile Thermostat](https://github.com/jmcollin78/versatile_thermostat) ⭐ 1,170 | 🐛 21 | 🌐 Python | 📅 2026-09-10 - Full-featured thermostat with presets, window detection, motion-based comfort, and presence (1,075★).
...
* [Powercalc](https://github.com/bramstroker/homeassistant-powercalc) ⭐ 1,579 | 🐛 32 | 🌐 Python | 📅 2026-09-12 - Calculate estimated power consumption of lights and other devices, even those that don't report it themselves (1,503★).
...
* [Octopus Energy](https://github.com/BottlecapDave/HomeAssistant-OctopusEnergy) ⭐ 1,003 | 🐛 66 | 🌐 Python | 📅 2026-09-08 - Pull Octopus Energy tariffs, smart meter readings, intelligent dispatch slots, and saving sessions into your dashboard (940★).
* [Huawei Solar](https://github.com/wlcrs/huawei_solar) ⭐ 930 | 🐛 6 | 🌐 Python | 📅 2026-09-09 - Read and control Huawei solar inverters and home batteries over Modbus, including grid charge windows (899★).
* [SolaX Modbus](https://github.com/wills106/homeassistant-solax-modbus) ⭐ 515 | 🐛 48 | 🌐 Python | 📅 2026-09-12 - Talk to SolaX, Solinteg, Sofar, Growatt, and other inverters over Modbus, including read-only and inverter control modes (490★).
* [Solarman](https://github.com/davidrapan/ha-solarman) ⭐ 515 | 🐛 123 | 🌐 Python | 📅 2026-05-03 - Read Deye, Sofar, and other Solarman-branded inverters via the Solarman stick logger (483★).
...
* [OCPP](https://github.com/lbbrhzn/ocpp) ⭐ 395 | 🐛 36 | 🌐 Python | 📅 2026-09-09 - Bring electric vehicle chargers that speak OCPP into the energy dashboard, with start, stop, and per-session metering (372★).
...
* [Solis Sensor](https://github.com/hultenvp/solis-sensor) ⭐ 326 | 🐛 37 | 🌐 Python | 📅 2026-03-27 - Talks to the SolisCloud PV monitoring portal so you can pull Solis inverter generation, battery, and grid data into the energy dashboard (320★).
* [SolarEdge Modbus Multi](https://github.com/WillCodeForCats/solaredge-modbus-multi) ⭐ 323 | 🐛 19 | 🌐 Python | 📅 2026-09-11 - Reads SolarEdge inverters, meters, and batteries locally over Modbus/TCP, with multi-inverter and three-phase support (303★).
...
* [WebRTC Camera](https://github.com/AlexxIT/WebRTC) ⭐ 2,177 | 🐛 223 | 🌐 JavaScript | 📅 2025-11-26 - View RTSP streams from IP Cameras in real-time through WebRTC or MSE with Pan/Zoom controls (2,134★).
* [Tapo Control](https://github.com/JurajNyiri/HomeAssistant-Tapo-Control) ⭐ 1,995 | 🐛 30 | 🌐 Python | 📅 2026-09-08 - Control TP-Link Tapo cameras with PTZ, motion events, and a live RTSP stream (1,912★).
...
* [Frigate](https://github.com/blakeblackshear/frigate-hass-integration) ⭐ 1,259 | 🐛 32 | 🌐 Python | 📅 2026-09-04 - Integrate the Frigate NVR with local object detection into your dashboard, alerts, and snapshots (1,181★).
* [Dahua](https://github.com/rroller/dahua) ⭐ 560 | 🐛 298 | 🌐 Python | 📅 2026-09-10 - Pair Dahua cameras and doorbells with motion events, snapshots, sirens, and PTZ controls (541★).
...
* [Alexa Media Player](https://github.com/alandtse/alexa_media_player) ⭐ 1,976 | 🐛 24 | 🌐 Python | 📅 2026-09-12 - Control Amazon Alexa devices: announce, play media, and pull device state into your automations (1,948★).
* [YandexStation](https://github.com/AlexxIT/YandexStation) ⭐ 1,926 | 🐛 93 | 🌐 Python | 📅 2026-09-05 - Control Yandex Station speakers and other smart-home devices through Alice (1,868★).
...
* [View Assist Companion](https://github.com/msp1974/ViewAssist_Companion_App) ⭐ 482 | 🐛 40 | 🌐 Python | 📅 2026-09-08 - Companion Android app and integration that turns a tablet into a hands-free voice and dashboard satellite (374★).

### 🚗 Cars & EV charging

*Track your car's battery, location, and charging state, or control where and when it plugs in.*

* [Kia Uvo & Hyundai Bluelink](https://github.com/Hyundai-Kia-Connect/kia_uvo) ⭐ 930 | 🐛 32 | 🌐 Python | 📅 2026-09-11 - Track and control Kia Connect (Uvo) and Hyundai Bluelink cars across EU, Canada, and USA, including charging, climate, and lock state (870★).
...
* [Volkswagen Carnet](https://github.com/robinostlund/homeassistant-volkswagencarnet) ⭐ 704 | 🐛 7 | 🌐 Python | 📅 2026-09-10 - Track charging state, climate preconditioning, and remote lock and honk for Volkswagen cars on the Carnet platform (643★).
...
* [Audi Connect](https://github.com/audiconnect/audi_connect_ha) ⭐ 366 | 🐛 26 | 🌐 Python | 📅 2026-09-10 - Tracks Audi cars over the Audi Connect API, including charging state, range, lock, and climate preconditioning (338★).
* [EV Smart Charging](https://github.com/jonasbkarlsson/ev_smart_charging) ⭐ 324 | 🐛 75 | 🌐 Python | 📅 2026-08-31 - Plans an electric vehicle charging schedule across the cheapest hours of a dynamic tariff, working with most chargers and price sensors (297★).
...
* [Stellantis Vehicles](https://github.com/andreadegiovine/homeassistant-stellantis-vehicles) ⭐ 271 | 🐛 13 | 🌐 Python | 📅 2026-09-11 - Adds Stellantis cars (Peugeot, Citroen, Fiat, Opel, Vauxhall, DS) over the manufacturer API for range, lock, and climate (231★).
...
* [iPhone Detect](https://github.com/mudape/iphonedetect) ⭐ 648 | 🐛 6 | 🌐 Python | 📅 2026-07-03 - Detect iPhones (and other phones) on the local Wi-Fi without an app, by sending a UDP probe and watching for the reply (625★).
* [Flightradar24](https://github.com/AlexandrErohin/home-assistant-flightradar24) ⭐ 537 | 🐛 25 | 🌐 Python | 📅 2026-09-08 - Track aircraft flying over a configurable bounding box around your home using Flightradar24 (468★).
...
* [Dreame Vacuum](https://github.com/Tasshack/dreame-vacuum) ⭐ 2,179 | 🐛 32 | 🌐 Python | 📅 2026-06-21 - Dreame robot vacuums with full map support, including no-go zones and selective room cleaning (1,999★).
...
* [EcoFlow BLE](https://github.com/rabits/ha-ef-ble) ⭐ 380 | 🐛 63 | 🌐 Python | 📅 2026-09-10 - Pulls EcoFlow power stations and accessories over Bluetooth Low Energy, no cloud account required (304★).
* [BLE Battery Management Systems](https://github.com/patman15/BMS_BLE-HA) ⭐ 359 | 🐛 18 | 🌐 Python | 📅 2026-09-10 - Reads Bluetooth Low Energy battery management systems (BMS) from many vendors, exposing per-cell voltages, balancing, and SOC (328★).

### 🔋 Battery monitoring

*Keep an eye on the batteries in all your devices and get warned before they run flat.*

* [Battery Notes](https://github.com/andrew-codechimp/HA-Battery-Notes) ⭐ 1,164 | 🐛 7 | 🌐 Python | 📅 2026-09-11 - Annotate every device with its battery type and quantity, then track replacements, low-battery warnings, and history (1,105★).
...
* [Xiaomi MIoT](https://github.com/al-one/hass-xiaomi-miot) ⭐ 6,110 | 🐛 923 | 🌐 Python | 📅 2026-09-09 - Auto-integrate Xiaomi smart-home devices over Wi-Fi, BLE, and Zigbee using the MIoT-spec protocol (5,911★).
* [LocalTuya](https://github.com/rospogrigio/localtuya) ⭐ 3,966 | 🐛 1,583 | 🌐 Python | 📅 2026-01-29 - Local control of Tuya devices over the LAN, no cloud round-trips, supporting plugs, lights, climate, and covers (3,857★).
...
* [SmartThinQ Sensors](https://github.com/ollo69/ha-smartthinq-sensors) ⭐ 1,321 | 🐛 155 | 🌐 Python | 📅 2026-05-25 - LG appliances (washers, dryers, AC, fridges) wired up via SmartThinQ with rich state and remote start (1,310★).
...
* [HomeMatic IP Local](https://github.com/SukramJ/homematicip_local) ⭐ 593 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - Local control of HomeMatic and HomeMatic IP devices through OpenCCU or RaspberryMatic, no cloud round-trips (572★).
...
* [Home Connect Local](https://github.com/chris-mc1/homeconnect_local_hass) ⭐ 455 | 🐛 64 | 🌐 Python | 📅 2026-09-09 - Talks to Bosch, Siemens, NEFF, and Gaggenau appliances directly over the local network, no cloud detour (390★).
* [Dyson](https://github.com/libdyson-wg/ha-dyson) ⭐ 433 | 🐛 81 | 🌐 Python | 📅 2025-08-15 - Wi-Fi connected Dyson fans, purifiers, and humidifiers, with full per-mode control over the local network (418★).
...
* [Browser Mod](https://github.com/thomasloven/hass-browser_mod) ⭐ 1,809 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-11 - Turn each browser into a controllable entity: pop up cards, navigate views, play sounds, or detect who is looking at the dashboard (1,748★).
...
* [Pyscript](https://github.com/custom-components/pyscript) ⭐ 1,184 | 🐛 136 | 🌐 Python | 📅 2026-09-11 - Write automations and templates in Python instead of YAML (1,159★).
...
* [Multiscrape](https://github.com/danieldotnl/ha-multiscrape) ⭐ 450 | 🐛 17 | 🌐 Python | 📅 2026-09-11 - Scrape multiple values (HTML, XML, or JSON) from a page in one request and turn them into sensors (437★).
...
* [Mail and Packages](https://github.com/moralmunky/Home-Assistant-Mail-And-Packages) ⭐ 885 | 🐛 16 | 🌐 Python | 📅 2026-09-12 - Sensors for incoming and delivered packages plus USPS Informed Delivery preview images, all from your existing email account (844★).
* [Smart Irrigation](https://github.com/jeroenterheerdt/HAsmartirrigation) ⭐ 550 | 🐛 23 | 🌐 Python | 📅 2026-09-06 - Calculates how long to run each irrigation zone based on evapotranspiration, recent rainfall, and weather forecasts (509★).
...
* [UK Bin Collection](https://github.com/robbrad/UKBinCollectionData) ⭐ 348 | 🐛 8 | 🌐 Python | 📅 2026-09-05 - Council bin collection schedules across UK local authorities, exposed as next-pickup sensors per waste stream (328★).

### 🔐 Network & authentication

*Sign in to Home Assistant with single sign-on, route through a tunnel, or pull network hardware into your dashboard.*

* [OIDC Auth](https://github.com/christiaangoossens/hass-oidc-auth) ⭐ 1,065 | 🐛 5 | 🌐 Python | 📅 2026-09-12 - Sign in with single sign-on through any OpenID Connect provider, including Authelia, Authentik, Keycloak, and Pocket ID (936★).
...
* [Unraid](https://github.com/ruaan-deysel/ha-unraid) ⭐ 252 | 🐛 9 | 🌐 Python | 📅 2026-09-07 - Monitors and controls an Unraid NAS, including CPU, memory, disks, virtual machines, and Docker containers (240★).
...
* [Auto-Entities Card](https://github.com/thomasloven/lovelace-auto-entities) ⭐ 1,804 | 🐛 168 | 🌐 TypeScript | 📅 2026-05-09 - Dynamically adds entities: 🔮 Magic (1,756★).
...
* [Swipe Navigation](https://github.com/zanna-37/hass-swipe-navigation) ⭐ 568 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-06 - Switch between dashboard views with a swipe gesture on mobile (543★).
...
* [Paper Buttons Row](https://github.com/jcwillox/lovelace-paper-buttons-row) ⭐ 366 | 🐛 73 | 🌐 TypeScript | 📅 2026-09-10 - Highly configurable button rows that can call actions, fire haptics, and restyle per state (359★).
...
* [Scheduler Card](https://github.com/nielsfaber/scheduler-card) ⭐ 1,256 | 🐛 13 | 🌐 TypeScript | 📅 2026-06-30 - Build and edit weekly schedules for any entity right from the dashboard (1,236★).
...
* [Entity Progress Card](https://github.com/francois-le-ko4la/lovelace-entity-progress-card) ⭐ 275 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-06 - Progress-bar card for any numeric entity, with thresholds, gradients, and templated icons (257★).
...
* [Horizon Card](https://github.com/rejuvenate/lovelace-horizon-card) ⭐ 677 | 🐛 23 | 🌐 TypeScript | 📅 2026-07-23 - Visualises the position of the Sun over the horizon throughout the day, with sunrise, sunset, and twilight markers (652★).
* [Weather Radar](https://github.com/Makin-Things/weather-radar-card) ⭐ 449 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-27 - Animated rain radar card using the public RainViewer tile service, with country-level and regional zoom (384★).
...
* [ha-map-card](https://github.com/nathan-gs/ha-map-card) ⭐ 136 | 🐛 45 | 🌐 JavaScript | 📅 2026-09-10 - Leaflet-based map card with history trails, custom tile layers, and tap actions (116★).

### 📸 Camera cards

*Display camera streams the way you want them, with overlays, controls, event timelines, and pop-out viewers.*

* [Advanced Camera Card](https://github.com/dermotduffy/advanced-camera-card) ⭐ 1,153 | 🐛 126 | 🌐 TypeScript | 📅 2026-09-10 - Comprehensive camera card with timelines, galleries, snapshots, clips, and per-event playback (1,077★).
...
* [Vacuum Card](https://github.com/denysdovhan/vacuum-card) ⭐ 1,251 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-12 - A card for controlling a robot vacuum (1,211★).
* [Valetudo Map](https://github.com/Hypfer/lovelace-valetudo-map-card) ⭐ 315 | 🐛 19 | 🌐 TypeScript | 📅 2024-12-15 - Display the live map from a robot vacuum running Valetudo (cloudless firmware) directly on a dashboard (304★).

### 📅 Calendar & feed

*Calendar views and rolling feeds of upcoming events.*

* [Calendar Card Pro](https://github.com/alexpfau/calendar-card-pro) ⭐ 1,206 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-11 - Customizable calendar card with event grouping, location indicators, and a clean modern look (1,122★).
...
* [HA Firemote](https://github.com/PRProd/HA-Firemote) ⭐ 1,050 | 🐛 200 | 📅 2026-03-08 - Virtual remote for Apple TV, Fire TV, Chromecast, Homatics, Shield, onn., Roku, Xiaomi, and more (987★).
...
* [Wall Panel](https://github.com/j-a-n/lovelace-wallpanel) ⭐ 879 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-23 - Wall-panel mode and photo-screensaver for tablets mounted on the wall (842★).
* [Kiosk Mode](https://github.com/NemesisRE/kiosk-mode) ⭐ 793 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-12 - Hide the header, sidebar, and overflow menu for a clean kiosk-style view (738★).
...
* [LCARS](https://github.com/th3jesta/ha-lcars) ⭐ 573 | 🐛 14 | 🌐 Python | 📅 2026-09-11 - Star Trek LCARS-inspired theme for the bridge feel (534★).
* [Catppuccin](https://github.com/catppuccin/home-assistant) ⭐ 499 | 🐛 10 | 📅 2026-09-11 - Soothing pastel theme matching the popular Catppuccin palette across editors and apps (427★).
...
* [DuckDNS](https://github.com/home-assistant/hassio-addons/blob/master/duckdns/DOCS.md) ⭐ 2,220 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Updates your Duck DNS IP address and generates SSL using Let's Encrypt.
* [File editor](https://github.com/home-assistant/hassio-addons/blob/master/configurator/DOCS.md) ⭐ 2,220 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Browser-based configuration file editor.
* [Mosquitto](https://github.com/home-assistant/hassio-addons/blob/master/mosquitto/DOCS.md) ⭐ 2,220 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Fast and reliable MQTT broker.
* [Terminal & SSH](https://github.com/home-assistant/hassio-addons/blob/master/ssh/DOCS.md) ⭐ 2,220 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Allows logging in remotely using a web terminal or SSH client.
* [Samba](https://github.com/home-assistant/hassio-addons/blob/master/samba/DOCS.md) ⭐ 2,220 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Access your configuration files using Windows network shares.
* [NGINX SSL proxy](https://github.com/home-assistant/hassio-addons/blob/master/nginx_proxy/DOCS.md) ⭐ 2,220 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Reverse proxy with SSL termination.
* [deCONZ](https://github.com/home-assistant/hassio-addons/blob/master/deconz/DOCS.md) ⭐ 2,220 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Control a ZigBee network using ConBee or RaspBee hardware by Dresden Elektronik.
* [Let's Encrypt](https://github.com/home-assistant/hassio-addons/blob/master/letsencrypt/DOCS.md) ⭐ 2,220 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Get a free SSL certificate from Let's Encrypt; an open and automated certificate authority (CA).
* [MariaDB](https://github.com/home-assistant/hassio-addons/blob/master/mariadb/DOCS.md) ⭐ 2,220 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - An open source relational database (fork of MySQL).

### 📦 Third Party Apps

*Anyone can create an app, the following are created by the community.*

* [zigbee2mqtt](https://github.com/Koenkk/zigbee2mqtt) ⭐ 15,628 | 🐛 458 | 🌐 TypeScript | 📅 2026-09-11 - Zigbee to MQTT bridge, get rid of your proprietary Zigbee bridges (15,213★).
...
* [Node-RED](https://github.com/hassio-addons/app-node-red) ⭐ 649 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-11 - Flow-based programming for the Internet of Things (639★).
...
* [Grocy](https://github.com/hassio-addons/app-grocy) ⭐ 451 | 🐛 6 | 🌐 Dockerfile | 📅 2026-09-12 - ERP beyond your fridge! A groceries & household management solution for your home (433★).
...
* [UniFi Controller](https://github.com/hassio-addons/app-unifi) ⭐ 380 | 🐛 5 | 🌐 Dockerfile | 📅 2026-08-27 - The UniFi Controller allows you to manage your UniFi network using a web browser (374★).
* [motionEye](https://github.com/hassio-addons/addon-motioneye) ⭐ 337 | 🐛 4 | 🌐 Dockerfile | 📅 2026-09-11 - Simple, elegant and feature-rich CCTV/NVR for your cameras (332★).
...
* [JupyterLab](https://github.com/hassio-addons/addon-jupyterlab) ⭐ 70 | 🐛 1 | 🌐 Dockerfile | 📅 2026-09-11 - Create documents containing live code, equations, visualizations, and explanatory text (68★).
...
* [Tasmota](https://github.com/arendst/Tasmota) ⭐ 24,753 | 🐛 16 | 🌐 C | 📅 2026-09-11 - Firmware for ESP8266 boards and devices (24,475★).
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,093 | 🐛 49 | 🌐 C++ | 📅 2026-09-12 - A flexible MQTT gateway for IR, RF, BLE, MiFlora, SMS, and many sensors (4,023★).
...
* [Homebridge](https://github.com/homebridge/homebridge) ⭐ 25,485 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-30 - Lightweight Node.js server that bridges non-HomeKit devices into Apple Home, with a large plugin ecosystem (25,384★).
* [Node-RED](https://github.com/node-red/node-red) ⭐ 23,646 | 🐛 332 | 🌐 JavaScript | 📅 2026-09-09 - Flow-based visual programming tool for wiring together devices, APIs, and services, backed by the OpenJS Foundation (23,277★).
* [Domoticz](https://github.com/domoticz/domoticz) ⭐ 3,802 | 🐛 22 | 🌐 C++ | 📅 2026-09-10 - A lightweight Home Automation System (3,773★).
* [Gladys](https://github.com/GladysAssistant/Gladys) ⭐ 3,190 | 🐛 52 | 🌐 JavaScript | 📅 2026-09-07 - Open source program which runs on your Raspberry Pi (3,066★).
...
* [Jeedom](https://github.com/jeedom/core) ⭐ 414 | 🐛 54 | 🌐 PHP | 📅 2026-09-12 - French-origin, cloudless platform with a plugin marketplace, running on any Linux system (414★).
...
* [awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 318,668 | 🐛 0 | 📅 2026-09-12 - Curated list of awesome self hosted software (298,647★).
...
* [awesome-mqtt](https://github.com/awesome-mqtt/awesome-mqtt#readme) ⭐ 2,395 | 🐛 0 | 📅 2026-09-01 - Curated list of MQTT related stuff (2,350★).

## Contributing

This awesome list is an active open-source project and is always open to
people who want to contribute to it. We have set up a separate document
containing our [Contribution Guidelines](https://github.com/frenck/awesome-home-assistant/blob/main/.github/CONTRIBUTING.md) ⭐ 8,435 | 🐛 22 | 🌐 Python | 📅 2026-09-11.
...
[contributor's page](https://github.com/frenck/awesome-home-assistant/graphs/contributors) ⭐ 8,435 | 🐛 22 | 🌐 Python | 📅 2026-09-11.
