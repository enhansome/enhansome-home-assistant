...
please read the [guide](https://github.com/frenck/awesome-home-assistant/blob/main/.github/CONTRIBUTING.md) ⭐ 8,433 | 🐛 22 | 🌐 Python | 📅 2026-09-11
or raise an [issue](https://github.com/frenck/awesome-home-assistant/issues/new/choose) ⭐ 8,433 | 🐛 22 | 🌐 Python | 📅 2026-09-11
...
* [Frigate Discussions](https://github.com/blakeblackshear/frigate/discussions) ⭐ 35,763 | 🐛 161 | 🌐 TypeScript | 📅 2026-09-10 - GitHub Discussions for the local-NVR / object-detection project.
* [Zigbee2MQTT Discussions](https://github.com/Koenkk/zigbee2mqtt/discussions) ⭐ 15,624 | 🐛 452 | 🌐 TypeScript | 📅 2026-09-11 - GitHub Discussions for the popular Zigbee bridge.
...
* [Carlo Costanzo](https://github.com/CCOSTAN/Home-AssistantConfig#logo) ⭐ 5,280 | 🐛 91 | 🌐 Python | 📅 2026-09-10 - Probably the most documented configuration out there (5,208★).
...
* [Adaptive Lighting](https://github.com/basnijholt/adaptive-lighting) ⭐ 3,460 | 🐛 143 | 🌐 Python | 📅 2026-09-10 - Slowly adjust the brightness and color temperature of your lights based on the position of the sun (3,324★).
...
* [Better Thermostat](https://github.com/KartoffelToby/better_thermostat) ⭐ 1,480 | 🐛 60 | 🌐 Python | 📅 2026-09-11 - Smarter thermostat with window detection, heating curves, and per-room comfort profiles for thermostatic radiator valves (1,443★).
...
* [Powercalc](https://github.com/bramstroker/homeassistant-powercalc) ⭐ 1,579 | 🐛 30 | 🌐 Python | 📅 2026-09-08 - Calculate estimated power consumption of lights and other devices, even those that don't report it themselves (1,503★).
...
* [Octopus Energy](https://github.com/BottlecapDave/HomeAssistant-OctopusEnergy) ⭐ 1,003 | 🐛 64 | 🌐 Python | 📅 2026-09-08 - Pull Octopus Energy tariffs, smart meter readings, intelligent dispatch slots, and saving sessions into your dashboard (940★).
...
* [SolaX Modbus](https://github.com/wills106/homeassistant-solax-modbus) ⭐ 515 | 🐛 59 | 🌐 Python | 📅 2026-09-04 - Talk to SolaX, Solinteg, Sofar, Growatt, and other inverters over Modbus, including read-only and inverter control modes (490★).
* [Solarman](https://github.com/davidrapan/ha-solarman) ⭐ 515 | 🐛 122 | 🌐 Python | 📅 2026-05-03 - Read Deye, Sofar, and other Solarman-branded inverters via the Solarman stick logger (483★).
...
* [OCPP](https://github.com/lbbrhzn/ocpp) ⭐ 395 | 🐛 34 | 🌐 Python | 📅 2026-09-09 - Bring electric vehicle chargers that speak OCPP into the energy dashboard, with start, stop, and per-session metering (372★).
* [FoxESS Modbus](https://github.com/nathanmarlor/foxess_modbus) ⭐ 333 | 🐛 63 | 🌐 Python | 📅 2026-09-07 - Connects directly to FoxESS solar inverters over Modbus, no cloud round-trips, for real-time status and control (308★).
...
* [Tapo Control](https://github.com/JurajNyiri/HomeAssistant-Tapo-Control) ⭐ 1,994 | 🐛 29 | 🌐 Python | 📅 2026-09-08 - Control TP-Link Tapo cameras with PTZ, motion events, and a live RTSP stream (1,912★).
...
* [Frigate](https://github.com/blakeblackshear/frigate-hass-integration) ⭐ 1,258 | 🐛 32 | 🌐 Python | 📅 2026-09-04 - Integrate the Frigate NVR with local object detection into your dashboard, alerts, and snapshots (1,181★).
* [Dahua](https://github.com/rroller/dahua) ⭐ 560 | 🐛 295 | 🌐 Python | 📅 2026-09-10 - Pair Dahua cameras and doorbells with motion events, snapshots, sirens, and PTZ controls (541★).
...
* [Keymaster](https://github.com/FutureTense/keymaster) ⭐ 348 | 🐛 11 | 🌐 Python | 📅 2026-09-10 - Manages user codes on Z-Wave smart locks, including per-user schedules, one-time codes, and notifications (334★).
...
* [Alexa Media Player](https://github.com/alandtse/alexa_media_player) ⭐ 1,976 | 🐛 29 | 🌐 Python | 📅 2026-09-07 - Control Amazon Alexa devices: announce, play media, and pull device state into your automations (1,948★).
* [YandexStation](https://github.com/AlexxIT/YandexStation) ⭐ 1,924 | 🐛 93 | 🌐 Python | 📅 2026-09-05 - Control Yandex Station speakers and other smart-home devices through Alice (1,868★).
* [Yandex Smart Home](https://github.com/dext0r/yandex_smart_home) ⭐ 1,079 | 🐛 7 | 🌐 Python | 📅 2026-09-02 - Expose your devices to Yandex Alice and the Yandex smart-home app (1,066★).
...
* [Kia Uvo & Hyundai Bluelink](https://github.com/Hyundai-Kia-Connect/kia_uvo) ⭐ 930 | 🐛 28 | 🌐 Python | 📅 2026-09-10 - Track and control Kia Connect (Uvo) and Hyundai Bluelink cars across EU, Canada, and USA, including charging, climate, and lock state (870★).
...
* [Stellantis Vehicles](https://github.com/andreadegiovine/homeassistant-stellantis-vehicles) ⭐ 271 | 🐛 11 | 🌐 Python | 📅 2026-09-11 - Adds Stellantis cars (Peugeot, Citroen, Fiat, Opel, Vauxhall, DS) over the manufacturer API for range, lock, and climate (231★).
...
* [Dreame Vacuum](https://github.com/Tasshack/dreame-vacuum) ⭐ 2,176 | 🐛 32 | 🌐 Python | 📅 2026-06-21 - Dreame robot vacuums with full map support, including no-go zones and selective room cleaning (1,999★).
...
* [BLE Monitor](https://github.com/custom-components/ble_monitor) ⭐ 2,240 | 🐛 120 | 🌐 Python | 📅 2026-09-10 - Passively read sensor data from Xiaomi MiBeacon, Govee, ATC, Inkbird, Qingping, and many other BLE sensors (2,214★).
* [Bermuda](https://github.com/agittins/bermuda) ⭐ 2,005 | 🐛 119 | 🌐 Python | 📅 2026-09-09 - Room-level presence detection by triangulating BLE signals across multiple ESPHome receivers (1,798★).
* [EcoFlow BLE](https://github.com/rabits/ha-ef-ble) ⭐ 379 | 🐛 62 | 🌐 Python | 📅 2026-09-10 - Pulls EcoFlow power stations and accessories over Bluetooth Low Energy, no cloud account required (304★).
...
* [Xiaomi MIoT](https://github.com/al-one/hass-xiaomi-miot) ⭐ 6,106 | 🐛 921 | 🌐 Python | 📅 2026-09-09 - Auto-integrate Xiaomi smart-home devices over Wi-Fi, BLE, and Zigbee using the MIoT-spec protocol (5,911★).
...
* [Sonoff LAN](https://github.com/AlexxIT/SonoffLAN) ⭐ 3,304 | 🐛 193 | 🌐 Python | 📅 2026-09-09 - Control Sonoff devices with eWeLink (original) firmware over LAN and/or Cloud (3,257★).
...
* [Midea AC LAN](https://github.com/wuwentao/midea_ac_lan) ⭐ 1,885 | 🐛 129 | 🌐 Python | 📅 2026-09-11 - Local control of Midea air conditioners, heat pumps, and other M-Smart devices (1,684★).
* [SmartThinQ Sensors](https://github.com/ollo69/ha-smartthinq-sensors) ⭐ 1,320 | 🐛 153 | 🌐 Python | 📅 2026-05-25 - LG appliances (washers, dryers, AC, fridges) wired up via SmartThinQ with rich state and remote start (1,310★).
...
* [HomeMatic IP Local](https://github.com/SukramJ/homematicip_local) ⭐ 593 | 🐛 1 | 🌐 Python | 📅 2026-09-11 - Local control of HomeMatic and HomeMatic IP devices through OpenCCU or RaspberryMatic, no cloud round-trips (572★).
...
* [Home Connect Local](https://github.com/chris-mc1/homeconnect_local_hass) ⭐ 454 | 🐛 64 | 🌐 Python | 📅 2026-09-09 - Talks to Bosch, Siemens, NEFF, and Gaggenau appliances directly over the local network, no cloud detour (390★).
...
* [hOn](https://github.com/gvigroux/hon) ⭐ 287 | 🐛 91 | 🌐 Python | 📅 2026-09-07 - Pulls Haier, Candy, and Hoover appliances from the official hOn cloud, exposing every state and parameter the app shows (253★).
...
* [Spook](https://github.com/frenck/spook) ⭐ 1,279 | 🐛 28 | 🌐 Python | 📅 2026-09-10 - A toolbox of helpful sensors, services, and templates that surface things the UI normally hides (1,138★).
...
* [Mail and Packages](https://github.com/moralmunky/Home-Assistant-Mail-And-Packages) ⭐ 885 | 🐛 18 | 🌐 Python | 📅 2026-09-11 - Sensors for incoming and delivered packages plus USPS Informed Delivery preview images, all from your existing email account (844★).
...
* [OIDC Auth](https://github.com/christiaangoossens/hass-oidc-auth) ⭐ 1,064 | 🐛 5 | 🌐 Python | 📅 2026-09-08 - Sign in with single sign-on through any OpenID Connect provider, including Authelia, Authentik, Keycloak, and Pocket ID (936★).
* [Mikrotik Router](https://github.com/tomaae/homeassistant-mikrotik_router) ⭐ 468 | 🐛 31 | 🌐 Python | 📅 2026-09-11 - Pulls Mikrotik routers and access points into your dashboard, with per-client traffic, DHCP leases, and PoE controls (453★).
...
* [TrueNAS](https://github.com/tomaae/homeassistant-truenas) ⭐ 386 | 🐛 23 | 🌐 Python | 📅 2026-08-05 - Pull TrueNAS Scale and Core stats, datasets, virtual machines, and apps into sensors and switches (370★).
...
* [Mushroom](https://github.com/piitaya/lovelace-mushroom) ⭐ 5,155 | 🐛 444 | 🌐 TypeScript | 📅 2026-09-01 - A complete card collection with a soft, mobile-first aesthetic that you can drop into existing dashboards (5,018★).
...
* [Floorplan](https://github.com/ExperienceLovelace/ha-floorplan) ⭐ 1,603 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-11 - Map entities onto an SVG of your house and animate them based on state changes (1,553★).
...
* [Card Modder](https://github.com/thomasloven/lovelace-card-mod) ⭐ 1,806 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-02 - Style your Lovelace cards (1,722★).
...
* [Mini Graph Card](https://github.com/kalkih/mini-graph-card) ⭐ 3,886 | 🐛 143 | 🌐 JavaScript | 📅 2026-09-11 - A minimalistic sensor graph card (3,830★).
...
* [Vehicle Status Card](https://github.com/ngocjohn/vehicle-status-card) ⭐ 300 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-05 - Dashboard card showing fuel or charge level, range, doors, lock state, and a customizable image of the car (262★).
...
* [Hourly Weather](https://github.com/decompil3d/lovelace-hourly-weather) ⭐ 403 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-11 - Show today's hourly forecast as a colored horizontal bar so you can see at a glance when conditions change (393★).

### 🎵 Media cards

*Better ways to control media players, with album art, queues, and per-room presence.*

* [Mini Media Player](https://github.com/kalkih/mini-media-player) ⭐ 1,714 | 🐛 214 | 🌐 TypeScript | 📅 2026-06-08 - A minimalistic media player card (1,701★).
...
* [ha-map-card](https://github.com/nathan-gs/ha-map-card) ⭐ 135 | 🐛 45 | 🌐 JavaScript | 📅 2026-09-10 - Leaflet-based map card with history trails, custom tile layers, and tap actions (116★).

### 📸 Camera cards

*Display camera streams the way you want them, with overlays, controls, event timelines, and pop-out viewers.*

* [Advanced Camera Card](https://github.com/dermotduffy/advanced-camera-card) ⭐ 1,149 | 🐛 123 | 🌐 TypeScript | 📅 2026-09-10 - Comprehensive camera card with timelines, galleries, snapshots, clips, and per-event playback (1,077★).
...
* [Vacuum Card](https://github.com/denysdovhan/vacuum-card) ⭐ 1,251 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-03 - A card for controlling a robot vacuum (1,211★).
...
* [Calendar Card Pro](https://github.com/alexpfau/calendar-card-pro) ⭐ 1,205 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-11 - Customizable calendar card with event grouping, location indicators, and a clean modern look (1,122★).
...
* [Trash Card](https://github.com/idaho/hassio-trash-card) ⭐ 374 | 🐛 81 | 🌐 TypeScript | 📅 2025-03-11 - Show the next trash pickup type (paper, plastic, organic) based on a calendar entity, with color-coded icons (356★).

### 📡 Remote control

*Virtual remotes for TVs, streamers, and AV gear.*

* [HA Firemote](https://github.com/PRProd/HA-Firemote) ⭐ 1,050 | 🐛 199 | 📅 2026-03-08 - Virtual remote for Apple TV, Fire TV, Chromecast, Homatics, Shield, onn., Roku, Xiaomi, and more (987★).
...
* [LG WebOS Remote Control](https://github.com/madmicio/LG-WebOS-Remote-Control) ⭐ 579 | 🐛 99 | 🌐 TypeScript | 📅 2026-05-08 - Remote Control for LG TV WebOS (551★).

### 🍃 Air quality

*Display readings from purifiers and air-quality sensors.*

* [Purifier Card](https://github.com/denysdovhan/purifier-card) ⭐ 342 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-03 - A card for controlling air purifiers (342★).

### 🖥️ Kiosk & wallpanel

*Hide the chrome, run full-screen, or turn an old tablet on the wall into a dedicated touch panel.*

* [Wall Panel](https://github.com/j-a-n/lovelace-wallpanel) ⭐ 878 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-23 - Wall-panel mode and photo-screensaver for tablets mounted on the wall (842★).
* [Kiosk Mode](https://github.com/NemesisRE/kiosk-mode) ⭐ 791 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-08 - Hide the header, sidebar, and overflow menu for a clean kiosk-style view (738★).
...
* [LCARS](https://github.com/th3jesta/ha-lcars) ⭐ 573 | 🐛 14 | 🌐 Python | 📅 2026-09-10 - Star Trek LCARS-inspired theme for the bridge feel (534★).
...
* [DuckDNS](https://github.com/home-assistant/hassio-addons/blob/master/duckdns/DOCS.md) ⭐ 2,219 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Updates your Duck DNS IP address and generates SSL using Let's Encrypt.
* [File editor](https://github.com/home-assistant/hassio-addons/blob/master/configurator/DOCS.md) ⭐ 2,219 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Browser-based configuration file editor.
* [Mosquitto](https://github.com/home-assistant/hassio-addons/blob/master/mosquitto/DOCS.md) ⭐ 2,219 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Fast and reliable MQTT broker.
* [Terminal & SSH](https://github.com/home-assistant/hassio-addons/blob/master/ssh/DOCS.md) ⭐ 2,219 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Allows logging in remotely using a web terminal or SSH client.
* [Samba](https://github.com/home-assistant/hassio-addons/blob/master/samba/DOCS.md) ⭐ 2,219 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Access your configuration files using Windows network shares.
* [NGINX SSL proxy](https://github.com/home-assistant/hassio-addons/blob/master/nginx_proxy/DOCS.md) ⭐ 2,219 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Reverse proxy with SSL termination.
* [deCONZ](https://github.com/home-assistant/hassio-addons/blob/master/deconz/DOCS.md) ⭐ 2,219 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Control a ZigBee network using ConBee or RaspBee hardware by Dresden Elektronik.
* [Let's Encrypt](https://github.com/home-assistant/hassio-addons/blob/master/letsencrypt/DOCS.md) ⭐ 2,219 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Get a free SSL certificate from Let's Encrypt; an open and automated certificate authority (CA).
* [MariaDB](https://github.com/home-assistant/hassio-addons/blob/master/mariadb/DOCS.md) ⭐ 2,219 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - An open source relational database (fork of MySQL).

### 📦 Third Party Apps

*Anyone can create an app, the following are created by the community.*

* [zigbee2mqtt](https://github.com/Koenkk/zigbee2mqtt) ⭐ 15,624 | 🐛 452 | 🌐 TypeScript | 📅 2026-09-11 - Zigbee to MQTT bridge, get rid of your proprietary Zigbee bridges (15,213★).
...
* [Node-RED](https://github.com/hassio-addons/app-node-red) ⭐ 648 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-10 - Flow-based programming for the Internet of Things (639★).
...
* [SSH & Web Terminal](https://github.com/hassio-addons/app-ssh) ⭐ 532 | 🐛 11 | 🌐 Shell | 📅 2026-09-10 - SSH and Web-based terminal with tons of pre-loaded useful tools (501★).
...
* [Spotify Connect](https://github.com/hassio-addons/app-spotify-connect) ⭐ 261 | 🐛 2 | 🌐 Jinja | 📅 2026-09-10 - Stream music from Spotify directly to your Home Assistant device (250★).
* [TasmoAdmin](https://github.com/hassio-addons/addon-tasmoadmin) ⭐ 259 | 🐛 3 | 🌐 Dockerfile | 📅 2026-09-11 - Centrally manage all your Sonoff-Tasmota devices (256★).
...
* [Plex Media Server](https://github.com/hassio-addons/app-plex) ⭐ 196 | 🐛 3 | 🌐 Jinja | 📅 2026-09-10 - Your recorded media beautifully organized and ready to stream (190★).
* [Glances](https://github.com/hassio-addons/app-glances) ⭐ 187 | 🐛 7 | 🌐 Shell | 📅 2026-09-11 - A cross-platform system monitoring tool written in Python (186★).
* [Traccar](https://github.com/hassio-addons/addon-traccar) ⭐ 160 | 🐛 3 | 🌐 Shell | 📅 2026-09-10 - Modern GPS tracking platform (158★).
...
* [Tasmota](https://github.com/arendst/Tasmota) ⭐ 24,751 | 🐛 14 | 🌐 C | 📅 2026-09-11 - Firmware for ESP8266 boards and devices (24,475★).
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,091 | 🐛 47 | 🌐 C++ | 📅 2026-09-08 - A flexible MQTT gateway for IR, RF, BLE, MiFlora, SMS, and many sensors (4,023★).
...
* [Node-RED](https://github.com/node-red/node-red) ⭐ 23,644 | 🐛 330 | 🌐 JavaScript | 📅 2026-09-09 - Flow-based visual programming tool for wiring together devices, APIs, and services, backed by the OpenJS Foundation (23,277★).
* [Domoticz](https://github.com/domoticz/domoticz) ⭐ 3,802 | 🐛 23 | 🌐 C++ | 📅 2026-09-10 - A lightweight Home Automation System (3,773★).
* [Gladys](https://github.com/GladysAssistant/Gladys) ⭐ 3,188 | 🐛 51 | 🌐 JavaScript | 📅 2026-09-07 - Open source program which runs on your Raspberry Pi (3,066★).
...
* [Jeedom](https://github.com/jeedom/core) ⭐ 413 | 🐛 53 | 🌐 PHP | 📅 2026-09-11 - French-origin, cloudless platform with a plugin marketplace, running on any Linux system (414★).
...
* [awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 318,468 | 🐛 0 | 📅 2026-09-10 - Curated list of awesome self hosted software (298,647★).
* [awesome-iot](https://github.com/HQarroum/awesome-iot) ⭐ 4,504 | 🐛 9 | 📅 2026-08-10 - Curated list of awesome Internet of Things projects and resources (3,948★).
...
containing our [Contribution Guidelines](https://github.com/frenck/awesome-home-assistant/blob/main/.github/CONTRIBUTING.md) ⭐ 8,433 | 🐛 22 | 🌐 Python | 📅 2026-09-11.
...
[contributor's page](https://github.com/frenck/awesome-home-assistant/graphs/contributors) ⭐ 8,433 | 🐛 22 | 🌐 Python | 📅 2026-09-11.
