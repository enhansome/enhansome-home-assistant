...
please read the [guide](https://github.com/frenck/awesome-home-assistant/blob/main/.github/CONTRIBUTING.md) ⭐ 8,424 | 🐛 22 | 🌐 Python | 📅 2026-09-07
or raise an [issue](https://github.com/frenck/awesome-home-assistant/issues/new/choose) ⭐ 8,424 | 🐛 22 | 🌐 Python | 📅 2026-09-07
...
* [Frigate Discussions](https://github.com/blakeblackshear/frigate/discussions) ⭐ 35,709 | 🐛 161 | 🌐 TypeScript | 📅 2026-09-07 - GitHub Discussions for the local-NVR / object-detection project.
* [Zigbee2MQTT Discussions](https://github.com/Koenkk/zigbee2mqtt/discussions) ⭐ 15,612 | 🐛 456 | 🌐 TypeScript | 📅 2026-09-06 - GitHub Discussions for the popular Zigbee bridge.
...
* [Carlo Costanzo](https://github.com/CCOSTAN/Home-AssistantConfig#logo) ⭐ 5,274 | 🐛 91 | 🌐 Python | 📅 2026-09-06 - Probably the most documented configuration out there (5,208★).
...
* [AI Automation Suggester](https://github.com/ITSpecialist111/ai_automation_suggester) ⭐ 776 | 🐛 3 | 🌐 Python | 📅 2026-09-05 - Scan your entities and ask an AI provider (OpenAI, Anthropic, Google, Groq, Ollama) for tailored automation suggestions, surfaced as notifications (749★).

### 💡 Lighting

*Effects, schedules, and behaviour layers that sit on top of your lights.*

* [Adaptive Lighting](https://github.com/basnijholt/adaptive-lighting) ⭐ 3,459 | 🐛 141 | 🌐 Python | 📅 2026-09-07 - Slowly adjust the brightness and color temperature of your lights based on the position of the sun (3,324★).
...
* [Powercalc](https://github.com/bramstroker/homeassistant-powercalc) ⭐ 1,580 | 🐛 22 | 🌐 Python | 📅 2026-09-08 - Calculate estimated power consumption of lights and other devices, even those that don't report it themselves (1,503★).
...
* [Octopus Energy](https://github.com/BottlecapDave/HomeAssistant-OctopusEnergy) ⭐ 1,001 | 🐛 65 | 🌐 Python | 📅 2026-08-29 - Pull Octopus Energy tariffs, smart meter readings, intelligent dispatch slots, and saving sessions into your dashboard (940★).
* [Huawei Solar](https://github.com/wlcrs/huawei_solar) ⭐ 930 | 🐛 9 | 🌐 Python | 📅 2026-09-05 - Read and control Huawei solar inverters and home batteries over Modbus, including grid charge windows (899★).
...
* [SolaX Modbus](https://github.com/wills106/homeassistant-solax-modbus) ⭐ 513 | 🐛 53 | 🌐 Python | 📅 2026-09-04 - Talk to SolaX, Solinteg, Sofar, Growatt, and other inverters over Modbus, including read-only and inverter control modes (490★).
...
* [OCPP](https://github.com/lbbrhzn/ocpp) ⭐ 394 | 🐛 31 | 🌐 Python | 📅 2026-09-08 - Bring electric vehicle chargers that speak OCPP into the energy dashboard, with start, stop, and per-session metering (372★).
...
* [Solis Sensor](https://github.com/hultenvp/solis-sensor) ⭐ 325 | 🐛 35 | 🌐 Python | 📅 2026-03-27 - Talks to the SolisCloud PV monitoring portal so you can pull Solis inverter generation, battery, and grid data into the energy dashboard (320★).
* [EPEX Spot](https://github.com/mampfes/ha_epex_spot) ⭐ 322 | 🐛 49 | 🌐 Python | 📅 2026-06-24 - Brings hourly EPEX spot electricity prices into your dashboard so you can shift loads to the cheapest slots (310★).
* [SolarEdge Modbus Multi](https://github.com/WillCodeForCats/solaredge-modbus-multi) ⭐ 322 | 🐛 20 | 🌐 Python | 📅 2026-09-06 - Reads SolarEdge inverters, meters, and batteries locally over Modbus/TCP, with multi-inverter and three-phase support (303★).
...
* [ENTSO-e Day-Ahead Prices](https://github.com/JaccoR/hass-entso-e) ⭐ 279 | 🐛 44 | 🌐 Python | 📅 2026-06-22 - Fetches day-ahead electricity prices from the ENTSO-e Transparency Platform across most European countries (265★).
...
* [WebRTC Camera](https://github.com/AlexxIT/WebRTC) ⭐ 2,174 | 🐛 223 | 🌐 JavaScript | 📅 2025-11-26 - View RTSP streams from IP Cameras in real-time through WebRTC or MSE with Pan/Zoom controls (2,134★).
...
* [Frigate](https://github.com/blakeblackshear/frigate-hass-integration) ⭐ 1,254 | 🐛 31 | 🌐 Python | 📅 2026-09-04 - Integrate the Frigate NVR with local object detection into your dashboard, alerts, and snapshots (1,181★).
* [Dahua](https://github.com/rroller/dahua) ⭐ 555 | 🐛 298 | 🌐 Python | 📅 2026-09-07 - Pair Dahua cameras and doorbells with motion events, snapshots, sirens, and PTZ controls (541★).
...
* [Alarmo](https://github.com/nielsfaber/alarmo) ⭐ 2,260 | 🐛 20 | 🌐 Python | 📅 2026-08-09 - Easy-to-use alarm system with arm/disarm flows, user codes, zones, and panic mode (2,148★).
* [Keymaster](https://github.com/FutureTense/keymaster) ⭐ 348 | 🐛 14 | 🌐 Python | 📅 2026-09-07 - Manages user codes on Z-Wave smart locks, including per-user schedules, one-time codes, and notifications (334★).
...
* [Alexa Media Player](https://github.com/alandtse/alexa_media_player) ⭐ 1,976 | 🐛 25 | 🌐 Python | 📅 2026-09-07 - Control Amazon Alexa devices: announce, play media, and pull device state into your automations (1,948★).
* [YandexStation](https://github.com/AlexxIT/YandexStation) ⭐ 1,922 | 🐛 92 | 🌐 Python | 📅 2026-09-05 - Control Yandex Station speakers and other smart-home devices through Alice (1,868★).
...
* [View Assist Companion](https://github.com/msp1974/ViewAssist_Companion_App) ⭐ 476 | 🐛 41 | 🌐 Python | 📅 2026-09-07 - Companion Android app and integration that turns a tablet into a hands-free voice and dashboard satellite (374★).

### 🚗 Cars & EV charging

*Track your car's battery, location, and charging state, or control where and when it plugs in.*

* [Kia Uvo & Hyundai Bluelink](https://github.com/Hyundai-Kia-Connect/kia_uvo) ⭐ 930 | 🐛 28 | 🌐 Python | 📅 2026-09-07 - Track and control Kia Connect (Uvo) and Hyundai Bluelink cars across EU, Canada, and USA, including charging, climate, and lock state (870★).
...
* [Volkswagen Carnet](https://github.com/robinostlund/homeassistant-volkswagencarnet) ⭐ 702 | 🐛 7 | 🌐 Python | 📅 2026-09-07 - Track charging state, climate preconditioning, and remote lock and honk for Volkswagen cars on the Carnet platform (643★).
...
* [Audi Connect](https://github.com/audiconnect/audi_connect_ha) ⭐ 366 | 🐛 29 | 🌐 Python | 📅 2026-09-07 - Tracks Audi cars over the Audi Connect API, including charging state, range, lock, and climate preconditioning (338★).
...
* [Easee EV Charger](https://github.com/nordicopen/easee_hass) ⭐ 280 | 🐛 32 | 🌐 Python | 📅 2026-07-24 - Adds Easee EV chargers with live charge state, dynamic load balancing, and per-session metering (272★).
* [Stellantis Vehicles](https://github.com/andreadegiovine/homeassistant-stellantis-vehicles) ⭐ 271 | 🐛 9 | 🌐 Python | 📅 2026-09-08 - Adds Stellantis cars (Peugeot, Citroen, Fiat, Opel, Vauxhall, DS) over the manufacturer API for range, lock, and climate (231★).
...
* [iCloud3](https://github.com/gcobb321/icloud3) ⭐ 902 | 🐛 99 | 🌐 Python | 📅 2026-09-07 - Improved version of the iCloud device tracker component with a lot of capabilities (855★).
...
* [Flightradar24](https://github.com/AlexandrErohin/home-assistant-flightradar24) ⭐ 535 | 🐛 27 | 🌐 Python | 📅 2026-09-02 - Track aircraft flying over a configurable bounding box around your home using Flightradar24 (468★).
...
* [BLE Monitor](https://github.com/custom-components/ble_monitor) ⭐ 2,238 | 🐛 115 | 🌐 Python | 📅 2026-08-24 - Passively read sensor data from Xiaomi MiBeacon, Govee, ATC, Inkbird, Qingping, and many other BLE sensors (2,214★).
* [Bermuda](https://github.com/agittins/bermuda) ⭐ 2,002 | 🐛 120 | 🌐 Python | 📅 2026-09-07 - Room-level presence detection by triangulating BLE signals across multiple ESPHome receivers (1,798★).
* [EcoFlow BLE](https://github.com/rabits/ha-ef-ble) ⭐ 375 | 🐛 63 | 🌐 Python | 📅 2026-09-07 - Pulls EcoFlow power stations and accessories over Bluetooth Low Energy, no cloud account required (304★).
...
* [Battery Notes](https://github.com/andrew-codechimp/HA-Battery-Notes) ⭐ 1,160 | 🐛 8 | 🌐 Python | 📅 2026-09-08 - Annotate every device with its battery type and quantity, then track replacements, low-battery warnings, and history (1,105★).
...
* [Xiaomi MIoT](https://github.com/al-one/hass-xiaomi-miot) ⭐ 6,103 | 🐛 921 | 🌐 Python | 📅 2026-09-07 - Auto-integrate Xiaomi smart-home devices over Wi-Fi, BLE, and Zigbee using the MIoT-spec protocol (5,911★).
...
* [Sonoff LAN](https://github.com/AlexxIT/SonoffLAN) ⭐ 3,301 | 🐛 195 | 🌐 Python | 📅 2026-09-02 - Control Sonoff devices with eWeLink (original) firmware over LAN and/or Cloud (3,257★).
...
* [Midea AC LAN](https://github.com/wuwentao/midea_ac_lan) ⭐ 1,882 | 🐛 127 | 🌐 Python | 📅 2026-09-08 - Local control of Midea air conditioners, heat pumps, and other M-Smart devices (1,684★).
...
* [PETLIBRO](https://github.com/jjjonesjr33/petlibro) ⭐ 363 | 🐛 22 | 🌐 Python | 📅 2026-08-16 - Adds PETLIBRO smart pet feeders and fountains, with feeding schedules, dispense events, and battery levels (319★).
...
* [hOn](https://github.com/gvigroux/hon) ⭐ 285 | 🐛 90 | 🌐 Python | 📅 2026-09-07 - Pulls Haier, Candy, and Hoover appliances from the official hOn cloud, exposing every state and parameter the app shows (253★).
...
* [Spook](https://github.com/frenck/spook) ⭐ 1,275 | 🐛 23 | 🌐 Python | 📅 2026-09-07 - A toolbox of helpful sensors, services, and templates that surface things the UI normally hides (1,138★).
...
* [OIDC Auth](https://github.com/christiaangoossens/hass-oidc-auth) ⭐ 1,059 | 🐛 11 | 🌐 Python | 📅 2026-09-07 - Sign in with single sign-on through any OpenID Connect provider, including Authelia, Authentik, Keycloak, and Pocket ID (936★).
...
* [TP-Link Router](https://github.com/AlexandrErohin/home-assistant-tplink-router) ⭐ 382 | 🐛 126 | 🌐 Python | 📅 2026-09-02 - Manages TP-Link and Mercusys routers with sensors, reboot button, switches, and per-client device tracking (348★).
...
* [Mushroom](https://github.com/piitaya/lovelace-mushroom) ⭐ 5,149 | 🐛 443 | 🌐 TypeScript | 📅 2026-09-01 - A complete card collection with a soft, mobile-first aesthetic that you can drop into existing dashboards (5,018★).
* [Bubble Card](https://github.com/Clooos/Bubble-Card) ⭐ 4,554 | 🐛 36 | 🌐 JavaScript | 📅 2026-09-04 - Minimalist card collection with a pop-up touch and rich customization (4,323★).
...
* [Auto-Entities Card](https://github.com/thomasloven/lovelace-auto-entities) ⭐ 1,801 | 🐛 168 | 🌐 TypeScript | 📅 2026-05-09 - Dynamically adds entities: 🔮 Magic (1,756★).
* [Card Modder](https://github.com/thomasloven/lovelace-card-mod) ⭐ 1,799 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-02 - Style your Lovelace cards (1,722★).
...
* [Mini Graph Card](https://github.com/kalkih/mini-graph-card) ⭐ 3,884 | 🐛 144 | 🌐 JavaScript | 📅 2026-09-08 - A minimalistic sensor graph card (3,830★).
...
* [Advanced Camera Card](https://github.com/dermotduffy/advanced-camera-card) ⭐ 1,149 | 🐛 117 | 🌐 TypeScript | 📅 2026-09-08 - Comprehensive camera card with timelines, galleries, snapshots, clips, and per-event playback (1,077★).
...
* [Calendar Card Pro](https://github.com/alexpfau/calendar-card-pro) ⭐ 1,202 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-08 - Customizable calendar card with event grouping, location indicators, and a clean modern look (1,122★).
...
* [Universal Remote Card](https://github.com/Nerwyn/universal-remote-card) ⭐ 595 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-06 - Fully customizable virtual remote for any media device, supporting custom buttons and haptics (569★).
* [LG WebOS Remote Control](https://github.com/madmicio/LG-WebOS-Remote-Control) ⭐ 578 | 🐛 98 | 🌐 TypeScript | 📅 2026-05-08 - Remote Control for LG TV WebOS (551★).
...
* [Kiosk Mode](https://github.com/NemesisRE/kiosk-mode) ⭐ 790 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-06 - Hide the header, sidebar, and overflow menu for a clean kiosk-style view (738★).
...
* [LCARS](https://github.com/th3jesta/ha-lcars) ⭐ 573 | 🐛 15 | 🌐 Python | 📅 2026-09-07 - Star Trek LCARS-inspired theme for the bridge feel (534★).
...
* [zigbee2mqtt](https://github.com/Koenkk/zigbee2mqtt) ⭐ 15,612 | 🐛 456 | 🌐 TypeScript | 📅 2026-09-06 - Zigbee to MQTT bridge, get rid of your proprietary Zigbee bridges (15,213★).
...
* [SSH & Web Terminal](https://github.com/hassio-addons/app-ssh) ⭐ 532 | 🐛 14 | 🌐 Shell | 📅 2026-09-06 - SSH and Web-based terminal with tons of pre-loaded useful tools (501★).
...
* [motionEye](https://github.com/hassio-addons/addon-motioneye) ⭐ 337 | 🐛 5 | 🌐 Dockerfile | 📅 2026-09-03 - Simple, elegant and feature-rich CCTV/NVR for your cameras (332★).
...
* [Glances](https://github.com/hassio-addons/app-glances) ⭐ 187 | 🐛 4 | 🌐 Shell | 📅 2026-09-03 - A cross-platform system monitoring tool written in Python (186★).
...
* [JupyterLab](https://github.com/hassio-addons/addon-jupyterlab) ⭐ 69 | 🐛 2 | 🌐 Dockerfile | 📅 2026-09-07 - Create documents containing live code, equations, visualizations, and explanatory text (68★).
...
* [Tasmota](https://github.com/arendst/Tasmota) ⭐ 24,742 | 🐛 15 | 🌐 C | 📅 2026-09-08 - Firmware for ESP8266 boards and devices (24,475★).
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,089 | 🐛 47 | 🌐 C++ | 📅 2026-09-08 - A flexible MQTT gateway for IR, RF, BLE, MiFlora, SMS, and many sensors (4,023★).
...
* [Homebridge](https://github.com/homebridge/homebridge) ⭐ 25,481 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-30 - Lightweight Node.js server that bridges non-HomeKit devices into Apple Home, with a large plugin ecosystem (25,384★).
* [Node-RED](https://github.com/node-red/node-red) ⭐ 23,635 | 🐛 330 | 🌐 JavaScript | 📅 2026-09-07 - Flow-based visual programming tool for wiring together devices, APIs, and services, backed by the OpenJS Foundation (23,277★).
* [Domoticz](https://github.com/domoticz/domoticz) ⭐ 3,802 | 🐛 20 | 🌐 C++ | 📅 2026-09-07 - A lightweight Home Automation System (3,773★).
* [Gladys](https://github.com/GladysAssistant/Gladys) ⭐ 3,182 | 🐛 48 | 🌐 JavaScript | 📅 2026-09-07 - Open source program which runs on your Raspberry Pi (3,066★).
...
* [Jeedom](https://github.com/jeedom/core) ⭐ 413 | 🐛 55 | 🌐 PHP | 📅 2026-09-08 - French-origin, cloudless platform with a plugin marketplace, running on any Linux system (414★).
...
* [awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 317,851 | 🐛 0 | 📅 2026-09-06 - Curated list of awesome self hosted software (298,647★).
...
* [awesome-mqtt](https://github.com/awesome-mqtt/awesome-mqtt#readme) ⭐ 2,393 | 🐛 0 | 📅 2026-09-01 - Curated list of MQTT related stuff (2,350★).

## Contributing

This awesome list is an active open-source project and is always open to
people who want to contribute to it. We have set up a separate document
containing our [Contribution Guidelines](https://github.com/frenck/awesome-home-assistant/blob/main/.github/CONTRIBUTING.md) ⭐ 8,424 | 🐛 22 | 🌐 Python | 📅 2026-09-07.
...
[contributor's page](https://github.com/frenck/awesome-home-assistant/graphs/contributors) ⭐ 8,424 | 🐛 22 | 🌐 Python | 📅 2026-09-07.
