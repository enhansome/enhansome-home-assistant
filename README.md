...
please read the [guide](https://github.com/frenck/awesome-home-assistant/blob/main/.github/CONTRIBUTING.md) ⭐ 8,420 | 🐛 22 | 🌐 Python | 📅 2026-09-07
or raise an [issue](https://github.com/frenck/awesome-home-assistant/issues/new/choose) ⭐ 8,420 | 🐛 22 | 🌐 Python | 📅 2026-09-07
...
* [Frigate Discussions](https://github.com/blakeblackshear/frigate/discussions) ⭐ 35,681 | 🐛 160 | 🌐 TypeScript | 📅 2026-09-06 - GitHub Discussions for the local-NVR / object-detection project.
* [Zigbee2MQTT Discussions](https://github.com/Koenkk/zigbee2mqtt/discussions) ⭐ 15,607 | 🐛 452 | 🌐 TypeScript | 📅 2026-09-06 - GitHub Discussions for the popular Zigbee bridge.
...
* [Carlo Costanzo](https://github.com/CCOSTAN/Home-AssistantConfig#logo) ⭐ 5,274 | 🐛 93 | 🌐 Python | 📅 2026-09-06 - Probably the most documented configuration out there (5,208★).
...
* [DubhAd](https://github.com/DubhAd/Home-AssistantConfig) ⭐ 687 | 🐛 1 | 🌐 HTML | 📅 2026-09-03 - Also known as Tinkerer, shares his configuration files (688★).
...
* [Adaptive Lighting](https://github.com/basnijholt/adaptive-lighting) ⭐ 3,460 | 🐛 137 | 🌐 Python | 📅 2026-09-07 - Slowly adjust the brightness and color temperature of your lights based on the position of the sun (3,324★).
...
* [Better Thermostat](https://github.com/KartoffelToby/better_thermostat) ⭐ 1,478 | 🐛 48 | 🌐 Python | 📅 2026-09-07 - Smarter thermostat with window detection, heating curves, and per-room comfort profiles for thermostatic radiator valves (1,443★).
* [Versatile Thermostat](https://github.com/jmcollin78/versatile_thermostat) ⭐ 1,169 | 🐛 18 | 🌐 Python | 📅 2026-09-06 - Full-featured thermostat with presets, window detection, motion-based comfort, and presence (1,075★).
...
* [Powercalc](https://github.com/bramstroker/homeassistant-powercalc) ⭐ 1,578 | 🐛 20 | 🌐 Python | 📅 2026-09-07 - Calculate estimated power consumption of lights and other devices, even those that don't report it themselves (1,503★).
* [Anker Solix](https://github.com/thomluther/ha-anker-solix) ⭐ 1,083 | 🐛 11 | 🌐 Python | 📅 2026-08-31 - Pull Anker Solix balcony solar systems, batteries, and power stations into the energy dashboard with live state, history, and charging control (1,005★).
* [Octopus Energy](https://github.com/BottlecapDave/HomeAssistant-OctopusEnergy) ⭐ 999 | 🐛 65 | 🌐 Python | 📅 2026-08-29 - Pull Octopus Energy tariffs, smart meter readings, intelligent dispatch slots, and saving sessions into your dashboard (940★).
* [Huawei Solar](https://github.com/wlcrs/huawei_solar) ⭐ 929 | 🐛 9 | 🌐 Python | 📅 2026-09-05 - Read and control Huawei solar inverters and home batteries over Modbus, including grid charge windows (899★).
* [Solarman](https://github.com/davidrapan/ha-solarman) ⭐ 514 | 🐛 123 | 🌐 Python | 📅 2026-05-03 - Read Deye, Sofar, and other Solarman-branded inverters via the Solarman stick logger (483★).
* [SolaX Modbus](https://github.com/wills106/homeassistant-solax-modbus) ⭐ 513 | 🐛 52 | 🌐 Python | 📅 2026-09-04 - Talk to SolaX, Solinteg, Sofar, Growatt, and other inverters over Modbus, including read-only and inverter control modes (490★).
...
* [OCPP](https://github.com/lbbrhzn/ocpp) ⭐ 394 | 🐛 32 | 🌐 Python | 📅 2026-09-06 - Bring electric vehicle chargers that speak OCPP into the energy dashboard, with start, stop, and per-session metering (372★).
...
* [SolarEdge Modbus Multi](https://github.com/WillCodeForCats/solaredge-modbus-multi) ⭐ 321 | 🐛 20 | 🌐 Python | 📅 2026-09-06 - Reads SolarEdge inverters, meters, and batteries locally over Modbus/TCP, with multi-inverter and three-phase support (303★).
* [Energi Data Service](https://github.com/MTrab/energidataservice) ⭐ 282 | 🐛 5 | 🌐 Python | 📅 2026-09-07 - Fetches Danish electricity spot prices from the Energi Data Service API for use in price-aware automations (275★).
...
* [Dynamic Energy Cost](https://github.com/martinarva/dynamic_energy_cost) ⭐ 199 | 🐛 5 | 🌐 Python | 📅 2026-09-06 - Tracks real-time and cumulative energy cost against a dynamic price feed like Nord Pool or EPEX (189★).

### 📹 Cameras & video

*Pair specific camera brands and video sources that Home Assistant does not support out of the box.*

* [WebRTC Camera](https://github.com/AlexxIT/WebRTC) ⭐ 2,173 | 🐛 223 | 🌐 JavaScript | 📅 2025-11-26 - View RTSP streams from IP Cameras in real-time through WebRTC or MSE with Pan/Zoom controls (2,134★).
* [Tapo Control](https://github.com/JurajNyiri/HomeAssistant-Tapo-Control) ⭐ 1,991 | 🐛 26 | 🌐 Python | 📅 2026-09-03 - Control TP-Link Tapo cameras with PTZ, motion events, and a live RTSP stream (1,912★).
...
* [Dahua](https://github.com/rroller/dahua) ⭐ 555 | 🐛 301 | 🌐 Python | 📅 2026-09-07 - Pair Dahua cameras and doorbells with motion events, snapshots, sirens, and PTZ controls (541★).
...
* [Alarmo](https://github.com/nielsfaber/alarmo) ⭐ 2,259 | 🐛 19 | 🌐 Python | 📅 2026-08-09 - Easy-to-use alarm system with arm/disarm flows, user codes, zones, and panic mode (2,148★).
* [Keymaster](https://github.com/FutureTense/keymaster) ⭐ 348 | 🐛 14 | 🌐 Python | 📅 2026-09-06 - Manages user codes on Z-Wave smart locks, including per-user schedules, one-time codes, and notifications (334★).
...
* [Alexa Media Player](https://github.com/alandtse/alexa_media_player) ⭐ 1,974 | 🐛 28 | 🌐 Python | 📅 2026-09-01 - Control Amazon Alexa devices: announce, play media, and pull device state into your automations (1,948★).
...
* [Kia Uvo & Hyundai Bluelink](https://github.com/Hyundai-Kia-Connect/kia_uvo) ⭐ 929 | 🐛 25 | 🌐 Python | 📅 2026-09-06 - Track and control Kia Connect (Uvo) and Hyundai Bluelink cars across EU, Canada, and USA, including charging, climate, and lock state (870★).
* [Tesla](https://github.com/alandtse/tesla) ⭐ 779 | 🐛 42 | 🌐 Python | 📅 2026-08-31 - Track Tesla cars and Powerwalls with charging, climate, location, and security state, using a refresh token from a third-party login app (740★).
* [Volkswagen Carnet](https://github.com/robinostlund/homeassistant-volkswagencarnet) ⭐ 702 | 🐛 9 | 🌐 Python | 📅 2026-09-07 - Track charging state, climate preconditioning, and remote lock and honk for Volkswagen cars on the Carnet platform (643★).
...
* [Stellantis Vehicles](https://github.com/andreadegiovine/homeassistant-stellantis-vehicles) ⭐ 270 | 🐛 15 | 🌐 Python | 📅 2026-09-06 - Adds Stellantis cars (Peugeot, Citroen, Fiat, Opel, Vauxhall, DS) over the manufacturer API for range, lock, and climate (231★).
...
* [iCloud3](https://github.com/gcobb321/icloud3) ⭐ 902 | 🐛 99 | 🌐 Python | 📅 2026-09-06 - Improved version of the iCloud device tracker component with a lot of capabilities (855★).
...
* [Flightradar24](https://github.com/AlexandrErohin/home-assistant-flightradar24) ⭐ 534 | 🐛 27 | 🌐 Python | 📅 2026-09-02 - Track aircraft flying over a configurable bounding box around your home using Flightradar24 (468★).
* [Places](https://github.com/custom-components/places) ⭐ 209 | 🐛 1 | 🌐 Python | 📅 2026-09-07 - Reverse-geocodes a device tracker location through OpenStreetMap so automations can react to "at the supermarket" rather than raw coordinates (191★).

### 🧹 Vacuums

*Control specific robot vacuums and surface their map data, beyond what comes built in.*

* [Dreame Vacuum](https://github.com/Tasshack/dreame-vacuum) ⭐ 2,173 | 🐛 31 | 🌐 Python | 📅 2026-06-21 - Dreame robot vacuums with full map support, including no-go zones and selective room cleaning (1,999★).
...
* [Bermuda](https://github.com/agittins/bermuda) ⭐ 2,001 | 🐛 120 | 🌐 Python | 📅 2026-09-07 - Room-level presence detection by triangulating BLE signals across multiple ESPHome receivers (1,798★).
* [EcoFlow BLE](https://github.com/rabits/ha-ef-ble) ⭐ 374 | 🐛 62 | 🌐 Python | 📅 2026-09-07 - Pulls EcoFlow power stations and accessories over Bluetooth Low Energy, no cloud account required (304★).
* [BLE Battery Management Systems](https://github.com/patman15/BMS_BLE-HA) ⭐ 358 | 🐛 16 | 🌐 Python | 📅 2026-08-31 - Reads Bluetooth Low Energy battery management systems (BMS) from many vendors, exposing per-cell voltages, balancing, and SOC (328★).

### 🔋 Battery monitoring

*Keep an eye on the batteries in all your devices and get warned before they run flat.*

* [Battery Notes](https://github.com/andrew-codechimp/HA-Battery-Notes) ⭐ 1,159 | 🐛 7 | 🌐 Python | 📅 2026-09-07 - Annotate every device with its battery type and quantity, then track replacements, low-battery warnings, and history (1,105★).
...
* [Xiaomi MIoT](https://github.com/al-one/hass-xiaomi-miot) ⭐ 6,100 | 🐛 922 | 🌐 Python | 📅 2026-09-07 - Auto-integrate Xiaomi smart-home devices over Wi-Fi, BLE, and Zigbee using the MIoT-spec protocol (5,911★).
...
* [Sonoff LAN](https://github.com/AlexxIT/SonoffLAN) ⭐ 3,301 | 🐛 193 | 🌐 Python | 📅 2026-09-02 - Control Sonoff devices with eWeLink (original) firmware over LAN and/or Cloud (3,257★).
* [SmartIR](https://github.com/smartHomeHub/SmartIR) ⭐ 2,823 | 🐛 233 | 🌐 Python | 📅 2025-07-21 - Integrates devices using Broadlink IR (2,733★).
...
* [Midea AC LAN](https://github.com/wuwentao/midea_ac_lan) ⭐ 1,880 | 🐛 124 | 🌐 Python | 📅 2026-09-07 - Local control of Midea air conditioners, heat pumps, and other M-Smart devices (1,684★).
...
* [Tapo Devices](https://github.com/petretiandrea/home-assistant-tapo-p100) ⭐ 969 | 🐛 21 | 🌐 Python | 📅 2026-08-11 - TP-Link Tapo plugs, switches, bulbs, and energy monitoring (P100, P105, P110, L510, L530, L900) over LAN (954★).
...
* [HomeMatic IP Local](https://github.com/SukramJ/homematicip_local) ⭐ 591 | 🐛 0 | 🌐 Python | 📅 2026-09-07 - Local control of HomeMatic and HomeMatic IP devices through OpenCCU or RaspberryMatic, no cloud round-trips (572★).
* [Nest Protect](https://github.com/iMicknl/ha-nest-protect) ⭐ 480 | 🐛 56 | 🌐 Python | 📅 2026-09-07 - Track Nest Protect smoke and CO alarms with battery state, recent events, and per-room safety status (468★).
* [Home Connect Local](https://github.com/chris-mc1/homeconnect_local_hass) ⭐ 451 | 🐛 61 | 🌐 Python | 📅 2026-09-07 - Talks to Bosch, Siemens, NEFF, and Gaggenau appliances directly over the local network, no cloud detour (390★).
* [Dyson](https://github.com/libdyson-wg/ha-dyson) ⭐ 434 | 🐛 80 | 🌐 Python | 📅 2025-08-15 - Wi-Fi connected Dyson fans, purifiers, and humidifiers, with full per-mode control over the local network (418★).
...
* [hOn](https://github.com/gvigroux/hon) ⭐ 285 | 🐛 89 | 🌐 Python | 📅 2026-09-07 - Pulls Haier, Candy, and Hoover appliances from the official hOn cloud, exposing every state and parameter the app shows (253★).
...
* [Browser Mod](https://github.com/thomasloven/hass-browser_mod) ⭐ 1,807 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-07 - Turn each browser into a controllable entity: pop up cards, navigate views, play sounds, or detect who is looking at the dashboard (1,748★).
* [Spook](https://github.com/frenck/spook) ⭐ 1,274 | 🐛 22 | 🌐 Python | 📅 2026-09-07 - A toolbox of helpful sensors, services, and templates that surface things the UI normally hides (1,138★).
...
* [Magic Areas](https://github.com/jseidl/magic-areas) ⭐ 517 | 🐛 17 | 🌐 Python | 📅 2026-09-05 - Auto-build per-room presence, climate, and media area entities, with motion-triggered scenes and bright/dark detection (493★).
...
* [Mail and Packages](https://github.com/moralmunky/Home-Assistant-Mail-And-Packages) ⭐ 883 | 🐛 9 | 🌐 Python | 📅 2026-09-05 - Sensors for incoming and delivered packages plus USPS Informed Delivery preview images, all from your existing email account (844★).
* [Smart Irrigation](https://github.com/jeroenterheerdt/HAsmartirrigation) ⭐ 549 | 🐛 19 | 🌐 Python | 📅 2026-09-06 - Calculates how long to run each irrigation zone based on evapotranspiration, recent rainfall, and weather forecasts (509★).
...
* [OIDC Auth](https://github.com/christiaangoossens/hass-oidc-auth) ⭐ 1,058 | 🐛 10 | 🌐 Python | 📅 2026-09-07 - Sign in with single sign-on through any OpenID Connect provider, including Authelia, Authentik, Keycloak, and Pocket ID (936★).
...
* [TP-Link Router](https://github.com/AlexandrErohin/home-assistant-tplink-router) ⭐ 381 | 🐛 126 | 🌐 Python | 📅 2026-09-02 - Manages TP-Link and Mercusys routers with sensors, reboot button, switches, and per-client device tracking (348★).
...
* [Mushroom](https://github.com/piitaya/lovelace-mushroom) ⭐ 5,147 | 🐛 443 | 🌐 TypeScript | 📅 2026-09-01 - A complete card collection with a soft, mobile-first aesthetic that you can drop into existing dashboards (5,018★).
* [Bubble Card](https://github.com/Clooos/Bubble-Card) ⭐ 4,556 | 🐛 36 | 🌐 JavaScript | 📅 2026-09-04 - Minimalist card collection with a pop-up touch and rich customization (4,323★).
* [UI Lovelace Minimalist](https://github.com/UI-Lovelace-Minimalist/UI) ⭐ 2,059 | 🐛 43 | 🌐 JavaScript | 📅 2026-09-07 - Drop-in dashboard collection with a uniform minimalist look across all your views, including ready-made cards and a button card library (2,036★).
* [Floorplan](https://github.com/ExperienceLovelace/ha-floorplan) ⭐ 1,601 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-07 - Map entities onto an SVG of your house and animate them based on state changes (1,553★).

### 📐 Layout helpers

*Cards that change where and how other cards appear: stack, fold, show conditionally, restyle, or template.*

* [Button card](https://github.com/custom-cards/button-card) ⭐ 2,493 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-06 - Highly customizable button for your entities (2,456★).
...
* [Card Modder](https://github.com/thomasloven/lovelace-card-mod) ⭐ 1,798 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-02 - Style your Lovelace cards (1,722★).
* [Layout Card](https://github.com/thomasloven/lovelace-layout-card) ⭐ 1,246 | 🐛 121 | 🌐 TypeScript | 📅 2026-05-09 - Get fine-grained control over how cards are placed on your dashboard, including masonry-style and grid layouts (1,246★).
...
* [Mini Graph Card](https://github.com/kalkih/mini-graph-card) ⭐ 3,883 | 🐛 146 | 🌐 JavaScript | 📅 2026-09-07 - A minimalistic sensor graph card (3,830★).
* [ApexCharts Card](https://github.com/RomRider/apexcharts-card) ⭐ 1,862 | 🐛 54 | 🌐 TypeScript | 📅 2026-02-03 - Advanced graphs and charts powered by ApexChartsJS with timelines, multi-axis, and event markers (1,797★).
...
* [Scheduler Card](https://github.com/nielsfaber/scheduler-card) ⭐ 1,254 | 🐛 11 | 🌐 TypeScript | 📅 2026-06-30 - Build and edit weekly schedules for any entity right from the dashboard (1,236★).
...
* [Entity Progress Card](https://github.com/francois-le-ko4la/lovelace-entity-progress-card) ⭐ 273 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-06 - Progress-bar card for any numeric entity, with thresholds, gradients, and templated icons (257★).

### ☀️ Weather cards

*Weather widgets with the look you actually want.*

* [Clock Weather Card](https://github.com/pkissling/clock-weather-card) ⭐ 869 | 🐛 102 | 🌐 TypeScript | 📅 2026-09-01 - Combined date, time, and weather forecast card with an iOS-inspired layout for the days ahead (841★).
...
* [Hourly Weather](https://github.com/decompil3d/lovelace-hourly-weather) ⭐ 403 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-07 - Show today's hourly forecast as a colored horizontal bar so you can see at a glance when conditions change (393★).
...
* [Sunsynk Power Flow](https://github.com/slipx06/sunsynk-power-flow-card) ⭐ 392 | 🐛 97 | 🌐 TypeScript | 📅 2026-05-12 - Visualise the live energy flow of Sunsynk and Deye inverters, mirroring the layout of the inverter screen (384★).
...
* [ha-map-card](https://github.com/nathan-gs/ha-map-card) ⭐ 135 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-07 - Leaflet-based map card with history trails, custom tile layers, and tap actions (116★).

### 📸 Camera cards

*Display camera streams the way you want them, with overlays, controls, event timelines, and pop-out viewers.*

* [Advanced Camera Card](https://github.com/dermotduffy/advanced-camera-card) ⭐ 1,148 | 🐛 122 | 🌐 TypeScript | 📅 2026-09-07 - Comprehensive camera card with timelines, galleries, snapshots, clips, and per-event playback (1,077★).
...
* [Vacuum Card](https://github.com/denysdovhan/vacuum-card) ⭐ 1,250 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-03 - A card for controlling a robot vacuum (1,211★).
...
* [Calendar Card Pro](https://github.com/alexpfau/calendar-card-pro) ⭐ 1,202 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-07 - Customizable calendar card with event grouping, location indicators, and a clean modern look (1,122★).
...
* [HA Firemote](https://github.com/PRProd/HA-Firemote) ⭐ 1,049 | 🐛 199 | 📅 2026-03-08 - Virtual remote for Apple TV, Fire TV, Chromecast, Homatics, Shield, onn., Roku, Xiaomi, and more (987★).
* [Universal Remote Card](https://github.com/Nerwyn/universal-remote-card) ⭐ 594 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-06 - Fully customizable virtual remote for any media device, supporting custom buttons and haptics (569★).
...
* [Wall Panel](https://github.com/j-a-n/lovelace-wallpanel) ⭐ 877 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-23 - Wall-panel mode and photo-screensaver for tablets mounted on the wall (842★).
* [Kiosk Mode](https://github.com/NemesisRE/kiosk-mode) ⭐ 789 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-06 - Hide the header, sidebar, and overflow menu for a clean kiosk-style view (738★).
...
* [Frosted Glass](https://github.com/wessamlauf/homeassistant-frosted-glass-themes) ⭐ 995 | 🐛 35 | 📅 2026-08-26 - Modern frosted-glass dark and light themes with translucent cards (907★).
...
* [LCARS](https://github.com/th3jesta/ha-lcars) ⭐ 572 | 🐛 14 | 🌐 Python | 📅 2026-09-06 - Star Trek LCARS-inspired theme for the bridge feel (534★).
...
* [DuckDNS](https://github.com/home-assistant/hassio-addons/blob/master/duckdns/DOCS.md) ⭐ 2,217 | 🐛 71 | 🌐 Shell | 📅 2026-08-31 - Updates your Duck DNS IP address and generates SSL using Let's Encrypt.
* [File editor](https://github.com/home-assistant/hassio-addons/blob/master/configurator/DOCS.md) ⭐ 2,217 | 🐛 71 | 🌐 Shell | 📅 2026-08-31 - Browser-based configuration file editor.
* [Mosquitto](https://github.com/home-assistant/hassio-addons/blob/master/mosquitto/DOCS.md) ⭐ 2,217 | 🐛 71 | 🌐 Shell | 📅 2026-08-31 - Fast and reliable MQTT broker.
* [Terminal & SSH](https://github.com/home-assistant/hassio-addons/blob/master/ssh/DOCS.md) ⭐ 2,217 | 🐛 71 | 🌐 Shell | 📅 2026-08-31 - Allows logging in remotely using a web terminal or SSH client.
* [Samba](https://github.com/home-assistant/hassio-addons/blob/master/samba/DOCS.md) ⭐ 2,217 | 🐛 71 | 🌐 Shell | 📅 2026-08-31 - Access your configuration files using Windows network shares.
* [NGINX SSL proxy](https://github.com/home-assistant/hassio-addons/blob/master/nginx_proxy/DOCS.md) ⭐ 2,217 | 🐛 71 | 🌐 Shell | 📅 2026-08-31 - Reverse proxy with SSL termination.
* [deCONZ](https://github.com/home-assistant/hassio-addons/blob/master/deconz/DOCS.md) ⭐ 2,217 | 🐛 71 | 🌐 Shell | 📅 2026-08-31 - Control a ZigBee network using ConBee or RaspBee hardware by Dresden Elektronik.
* [Let's Encrypt](https://github.com/home-assistant/hassio-addons/blob/master/letsencrypt/DOCS.md) ⭐ 2,217 | 🐛 71 | 🌐 Shell | 📅 2026-08-31 - Get a free SSL certificate from Let's Encrypt; an open and automated certificate authority (CA).
* [MariaDB](https://github.com/home-assistant/hassio-addons/blob/master/mariadb/DOCS.md) ⭐ 2,217 | 🐛 71 | 🌐 Shell | 📅 2026-08-31 - An open source relational database (fork of MySQL).

### 📦 Third Party Apps

*Anyone can create an app, the following are created by the community.*

* [zigbee2mqtt](https://github.com/Koenkk/zigbee2mqtt) ⭐ 15,607 | 🐛 452 | 🌐 TypeScript | 📅 2026-09-06 - Zigbee to MQTT bridge, get rid of your proprietary Zigbee bridges (15,213★).
...
* [SSH & Web Terminal](https://github.com/hassio-addons/app-ssh) ⭐ 531 | 🐛 14 | 🌐 Shell | 📅 2026-09-06 - SSH and Web-based terminal with tons of pre-loaded useful tools (501★).
...
* [Aircast](https://github.com/hassio-addons/app-aircast) ⭐ 402 | 🐛 4 | 🌐 Jinja | 📅 2026-09-06 - AirPlay capabilities for your Chromecast players (397★).
...
* [motionEye](https://github.com/hassio-addons/addon-motioneye) ⭐ 336 | 🐛 5 | 🌐 Dockerfile | 📅 2026-09-03 - Simple, elegant and feature-rich CCTV/NVR for your cameras (332★).
...
* [TasmoAdmin](https://github.com/hassio-addons/addon-tasmoadmin) ⭐ 260 | 🐛 3 | 🌐 Dockerfile | 📅 2026-09-03 - Centrally manage all your Sonoff-Tasmota devices (256★).
...
* [Plex Media Server](https://github.com/hassio-addons/app-plex) ⭐ 196 | 🐛 2 | 🌐 Jinja | 📅 2026-08-21 - Your recorded media beautifully organized and ready to stream (190★).
...
* [Traccar](https://github.com/hassio-addons/addon-traccar) ⭐ 160 | 🐛 3 | 🌐 Shell | 📅 2026-08-29 - Modern GPS tracking platform (158★).
...
* [JupyterLab](https://github.com/hassio-addons/addon-jupyterlab) ⭐ 69 | 🐛 1 | 🌐 Dockerfile | 📅 2026-09-07 - Create documents containing live code, equations, visualizations, and explanatory text (68★).
...
* [Tasmota](https://github.com/arendst/Tasmota) ⭐ 24,738 | 🐛 14 | 🌐 C | 📅 2026-09-07 - Firmware for ESP8266 boards and devices (24,475★).
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,086 | 🐛 47 | 🌐 C++ | 📅 2026-09-01 - A flexible MQTT gateway for IR, RF, BLE, MiFlora, SMS, and many sensors (4,023★).
...
* [Homebridge](https://github.com/homebridge/homebridge) ⭐ 25,479 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-30 - Lightweight Node.js server that bridges non-HomeKit devices into Apple Home, with a large plugin ecosystem (25,384★).
* [Node-RED](https://github.com/node-red/node-red) ⭐ 23,626 | 🐛 325 | 🌐 JavaScript | 📅 2026-09-01 - Flow-based visual programming tool for wiring together devices, APIs, and services, backed by the OpenJS Foundation (23,277★).
* [Domoticz](https://github.com/domoticz/domoticz) ⭐ 3,801 | 🐛 19 | 🌐 C++ | 📅 2026-09-07 - A lightweight Home Automation System (3,773★).
* [Gladys](https://github.com/GladysAssistant/Gladys) ⭐ 3,181 | 🐛 51 | 🌐 JavaScript | 📅 2026-09-07 - Open source program which runs on your Raspberry Pi (3,066★).
...
* [Jeedom](https://github.com/jeedom/core) ⭐ 413 | 🐛 59 | 🌐 PHP | 📅 2026-09-07 - French-origin, cloudless platform with a plugin marketplace, running on any Linux system (414★).
...
* [awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 317,643 | 🐛 0 | 📅 2026-09-06 - Curated list of awesome self hosted software (298,647★).
* [awesome-iot](https://github.com/HQarroum/awesome-iot) ⭐ 4,497 | 🐛 9 | 📅 2026-08-10 - Curated list of awesome Internet of Things projects and resources (3,948★).
* [awesome-mqtt](https://github.com/awesome-mqtt/awesome-mqtt#readme) ⭐ 2,392 | 🐛 0 | 📅 2026-09-01 - Curated list of MQTT related stuff (2,350★).

## Contributing

This awesome list is an active open-source project and is always open to
people who want to contribute to it. We have set up a separate document
containing our [Contribution Guidelines](https://github.com/frenck/awesome-home-assistant/blob/main/.github/CONTRIBUTING.md) ⭐ 8,420 | 🐛 22 | 🌐 Python | 📅 2026-09-07.
...
[contributor's page](https://github.com/frenck/awesome-home-assistant/graphs/contributors) ⭐ 8,420 | 🐛 22 | 🌐 Python | 📅 2026-09-07.
