...
please read the [guide](https://github.com/frenck/awesome-home-assistant/blob/main/.github/CONTRIBUTING.md) ⭐ 8,440 | 🐛 22 | 🌐 Python | 📅 2026-09-11
or raise an [issue](https://github.com/frenck/awesome-home-assistant/issues/new/choose) ⭐ 8,440 | 🐛 22 | 🌐 Python | 📅 2026-09-11
...
* [Frigate Discussions](https://github.com/blakeblackshear/frigate/discussions) ⭐ 35,804 | 🐛 159 | 🌐 TypeScript | 📅 2026-09-12 - GitHub Discussions for the local-NVR / object-detection project.
* [Zigbee2MQTT Discussions](https://github.com/Koenkk/zigbee2mqtt/discussions) ⭐ 15,631 | 🐛 457 | 🌐 TypeScript | 📅 2026-09-12 - GitHub Discussions for the popular Zigbee bridge.
...
* [Adaptive Lighting](https://github.com/basnijholt/adaptive-lighting) ⭐ 3,464 | 🐛 143 | 🌐 Python | 📅 2026-09-10 - Slowly adjust the brightness and color temperature of your lights based on the position of the sun (3,324★).
...
* [Better Thermostat](https://github.com/KartoffelToby/better_thermostat) ⭐ 1,480 | 🐛 50 | 🌐 Python | 📅 2026-09-12 - Smarter thermostat with window detection, heating curves, and per-room comfort profiles for thermostatic radiator valves (1,443★).
* [Versatile Thermostat](https://github.com/jmcollin78/versatile_thermostat) ⭐ 1,171 | 🐛 22 | 🌐 Python | 📅 2026-09-10 - Full-featured thermostat with presets, window detection, motion-based comfort, and presence (1,075★).
...
* [Powercalc](https://github.com/bramstroker/homeassistant-powercalc) ⭐ 1,581 | 🐛 22 | 🌐 Python | 📅 2026-09-13 - Calculate estimated power consumption of lights and other devices, even those that don't report it themselves (1,503★).
* [Anker Solix](https://github.com/thomluther/ha-anker-solix) ⭐ 1,086 | 🐛 12 | 🌐 Python | 📅 2026-09-07 - Pull Anker Solix balcony solar systems, batteries, and power stations into the energy dashboard with live state, history, and charging control (1,005★).
* [Octopus Energy](https://github.com/BottlecapDave/HomeAssistant-OctopusEnergy) ⭐ 1,003 | 🐛 64 | 🌐 Python | 📅 2026-09-12 - Pull Octopus Energy tariffs, smart meter readings, intelligent dispatch slots, and saving sessions into your dashboard (940★).
...
* [SolaX Modbus](https://github.com/wills106/homeassistant-solax-modbus) ⭐ 515 | 🐛 44 | 🌐 Python | 📅 2026-09-12 - Talk to SolaX, Solinteg, Sofar, Growatt, and other inverters over Modbus, including read-only and inverter control modes (490★).
...
* [OCPP](https://github.com/lbbrhzn/ocpp) ⭐ 395 | 🐛 35 | 🌐 Python | 📅 2026-09-13 - Bring electric vehicle chargers that speak OCPP into the energy dashboard, with start, stop, and per-session metering (372★).
* [FoxESS Modbus](https://github.com/nathanmarlor/foxess_modbus) ⭐ 334 | 🐛 63 | 🌐 Python | 📅 2026-09-07 - Connects directly to FoxESS solar inverters over Modbus, no cloud round-trips, for real-time status and control (308★).
...
* [Eufy Security](https://github.com/fuatakgun/eufy_security) ⭐ 1,391 | 🐛 214 | 🌐 Python | 📅 2026-06-22 - Manage Eufy Security cameras, doorbells, and base stations with live streams and event notifications (1,338★).
* [Frigate](https://github.com/blakeblackshear/frigate-hass-integration) ⭐ 1,262 | 🐛 31 | 🌐 Python | 📅 2026-09-12 - Integrate the Frigate NVR with local object detection into your dashboard, alerts, and snapshots (1,181★).
* [Dahua](https://github.com/rroller/dahua) ⭐ 560 | 🐛 297 | 🌐 Python | 📅 2026-09-13 - Pair Dahua cameras and doorbells with motion events, snapshots, sirens, and PTZ controls (541★).
* [HASS Aarlo](https://github.com/twrecked/hass-aarlo) ⭐ 476 | 🐛 84 | 🌐 Python | 📅 2026-08-14 - Asynchronous Arlo integration. Similar to the Arlo web site; monitors events and states for all base stations, cameras and doorbells (470★).

### 🚨 Security & alarm

*Turn Home Assistant into a fully-featured alarm system with arm and disarm flows, user codes, zones, and panic.*

* [Alarmo](https://github.com/nielsfaber/alarmo) ⭐ 2,263 | 🐛 23 | 🌐 Python | 📅 2026-08-09 - Easy-to-use alarm system with arm/disarm flows, user codes, zones, and panic mode (2,148★).
* [Keymaster](https://github.com/FutureTense/keymaster) ⭐ 348 | 🐛 11 | 🌐 Python | 📅 2026-09-11 - Manages user codes on Z-Wave smart locks, including per-user schedules, one-time codes, and notifications (334★).
...
* [Alexa Media Player](https://github.com/alandtse/alexa_media_player) ⭐ 1,976 | 🐛 27 | 🌐 Python | 📅 2026-09-12 - Control Amazon Alexa devices: announce, play media, and pull device state into your automations (1,948★).
...
* [Yandex Smart Home](https://github.com/dext0r/yandex_smart_home) ⭐ 1,083 | 🐛 7 | 🌐 Python | 📅 2026-09-02 - Expose your devices to Yandex Alice and the Yandex smart-home app (1,066★).
...
* [View Assist Companion](https://github.com/msp1974/ViewAssist_Companion_App) ⭐ 483 | 🐛 41 | 🌐 Python | 📅 2026-09-08 - Companion Android app and integration that turns a tablet into a hands-free voice and dashboard satellite (374★).

### 🚗 Cars & EV charging

*Track your car's battery, location, and charging state, or control where and when it plugs in.*

* [Kia Uvo & Hyundai Bluelink](https://github.com/Hyundai-Kia-Connect/kia_uvo) ⭐ 931 | 🐛 31 | 🌐 Python | 📅 2026-09-12 - Track and control Kia Connect (Uvo) and Hyundai Bluelink cars across EU, Canada, and USA, including charging, climate, and lock state (870★).
...
* [Volkswagen Carnet](https://github.com/robinostlund/homeassistant-volkswagencarnet) ⭐ 703 | 🐛 7 | 🌐 Python | 📅 2026-09-10 - Track charging state, climate preconditioning, and remote lock and honk for Volkswagen cars on the Carnet platform (643★).
...
* [Audi Connect](https://github.com/audiconnect/audi_connect_ha) ⭐ 366 | 🐛 25 | 🌐 Python | 📅 2026-09-10 - Tracks Audi cars over the Audi Connect API, including charging state, range, lock, and climate preconditioning (338★).
...
* [Stellantis Vehicles](https://github.com/andreadegiovine/homeassistant-stellantis-vehicles) ⭐ 271 | 🐛 10 | 🌐 Python | 📅 2026-09-13 - Adds Stellantis cars (Peugeot, Citroen, Fiat, Opel, Vauxhall, DS) over the manufacturer API for range, lock, and climate (231★).
...
* [iCloud3](https://github.com/gcobb321/icloud3) ⭐ 902 | 🐛 103 | 🌐 Python | 📅 2026-09-08 - Improved version of the iCloud device tracker component with a lot of capabilities (855★).
* [iPhone Detect](https://github.com/mudape/iphonedetect) ⭐ 649 | 🐛 6 | 🌐 Python | 📅 2026-07-03 - Detect iPhones (and other phones) on the local Wi-Fi without an app, by sending a UDP probe and watching for the reply (625★).
* [Flightradar24](https://github.com/AlexandrErohin/home-assistant-flightradar24) ⭐ 538 | 🐛 25 | 🌐 Python | 📅 2026-09-08 - Track aircraft flying over a configurable bounding box around your home using Flightradar24 (468★).
...
* [Dreame Vacuum](https://github.com/Tasshack/dreame-vacuum) ⭐ 2,181 | 🐛 35 | 🌐 Python | 📅 2026-06-21 - Dreame robot vacuums with full map support, including no-go zones and selective room cleaning (1,999★).
...
* [BLE Monitor](https://github.com/custom-components/ble_monitor) ⭐ 2,239 | 🐛 115 | 🌐 Python | 📅 2026-09-11 - Passively read sensor data from Xiaomi MiBeacon, Govee, ATC, Inkbird, Qingping, and many other BLE sensors (2,214★).
* [Bermuda](https://github.com/agittins/bermuda) ⭐ 2,006 | 🐛 123 | 🌐 Python | 📅 2026-09-09 - Room-level presence detection by triangulating BLE signals across multiple ESPHome receivers (1,798★).
* [EcoFlow BLE](https://github.com/rabits/ha-ef-ble) ⭐ 381 | 🐛 61 | 🌐 Python | 📅 2026-09-13 - Pulls EcoFlow power stations and accessories over Bluetooth Low Energy, no cloud account required (304★).
* [BLE Battery Management Systems](https://github.com/patman15/BMS_BLE-HA) ⭐ 360 | 🐛 18 | 🌐 Python | 📅 2026-09-10 - Reads Bluetooth Low Energy battery management systems (BMS) from many vendors, exposing per-cell voltages, balancing, and SOC (328★).
...
* [Xiaomi MIoT](https://github.com/al-one/hass-xiaomi-miot) ⭐ 6,114 | 🐛 921 | 🌐 Python | 📅 2026-09-13 - Auto-integrate Xiaomi smart-home devices over Wi-Fi, BLE, and Zigbee using the MIoT-spec protocol (5,911★).
* [LocalTuya](https://github.com/rospogrigio/localtuya) ⭐ 3,968 | 🐛 1,582 | 🌐 Python | 📅 2026-01-29 - Local control of Tuya devices over the LAN, no cloud round-trips, supporting plugs, lights, climate, and covers (3,857★).
* [Sonoff LAN](https://github.com/AlexxIT/SonoffLAN) ⭐ 3,305 | 🐛 193 | 🌐 Python | 📅 2026-09-09 - Control Sonoff devices with eWeLink (original) firmware over LAN and/or Cloud (3,257★).
...
* [Midea AC LAN](https://github.com/wuwentao/midea_ac_lan) ⭐ 1,886 | 🐛 128 | 🌐 Python | 📅 2026-09-11 - Local control of Midea air conditioners, heat pumps, and other M-Smart devices (1,684★).
* [SmartThinQ Sensors](https://github.com/ollo69/ha-smartthinq-sensors) ⭐ 1,320 | 🐛 155 | 🌐 Python | 📅 2026-05-25 - LG appliances (washers, dryers, AC, fridges) wired up via SmartThinQ with rich state and remote start (1,310★).
* [Home Connect Alt](https://github.com/ekutner/home-connect-hass) ⭐ 1,008 | 🐛 8 | 🌐 Python | 📅 2026-09-01 - Alternative Home Connect integration for Bosch, Siemens, NEFF, and Gaggenau ovens, dishwashers, and washing machines, with richer state than the official one (970★).
...
* [HomeMatic IP Local](https://github.com/SukramJ/homematicip_local) ⭐ 593 | 🐛 0 | 🌐 Python | 📅 2026-09-12 - Local control of HomeMatic and HomeMatic IP devices through OpenCCU or RaspberryMatic, no cloud round-trips (572★).
* [Nest Protect](https://github.com/iMicknl/ha-nest-protect) ⭐ 482 | 🐛 56 | 🌐 Python | 📅 2026-09-07 - Track Nest Protect smoke and CO alarms with battery state, recent events, and per-room safety status (468★).
* [Home Connect Local](https://github.com/chris-mc1/homeconnect_local_hass) ⭐ 458 | 🐛 65 | 🌐 Python | 📅 2026-09-09 - Talks to Bosch, Siemens, NEFF, and Gaggenau appliances directly over the local network, no cloud detour (390★).
...
* [Spook](https://github.com/frenck/spook) ⭐ 1,284 | 🐛 31 | 🌐 Python | 📅 2026-09-12 - A toolbox of helpful sensors, services, and templates that surface things the UI normally hides (1,138★).
...
* [The Watchman](https://github.com/dummylabs/thewatchman) ⭐ 684 | 🐛 47 | 🌐 Python | 📅 2026-03-25 - Keep track of missing entities and services in your config files (655★).
...
* [Mail and Packages](https://github.com/moralmunky/Home-Assistant-Mail-And-Packages) ⭐ 885 | 🐛 15 | 🌐 Python | 📅 2026-09-13 - Sensors for incoming and delivered packages plus USPS Informed Delivery preview images, all from your existing email account (844★).
* [Smart Irrigation](https://github.com/jeroenterheerdt/HAsmartirrigation) ⭐ 550 | 🐛 24 | 🌐 Python | 📅 2026-09-13 - Calculates how long to run each irrigation zone based on evapotranspiration, recent rainfall, and weather forecasts (509★).
...
* [UK Bin Collection](https://github.com/robbrad/UKBinCollectionData) ⭐ 349 | 🐛 8 | 🌐 Python | 📅 2026-09-05 - Council bin collection schedules across UK local authorities, exposed as next-pickup sensors per waste stream (328★).

### 🔐 Network & authentication

*Sign in to Home Assistant with single sign-on, route through a tunnel, or pull network hardware into your dashboard.*

* [OIDC Auth](https://github.com/christiaangoossens/hass-oidc-auth) ⭐ 1,068 | 🐛 5 | 🌐 Python | 📅 2026-09-12 - Sign in with single sign-on through any OpenID Connect provider, including Authelia, Authentik, Keycloak, and Pocket ID (936★).
...
* [Remote Home Assistant](https://github.com/custom-components/remote_homeassistant) ⭐ 1,262 | 🐛 119 | 🌐 Python | 📅 2025-12-04 - Link multiple instances together so entities, services, and events flow between them (1,232★).
...
* [TrueNAS](https://github.com/tomaae/homeassistant-truenas) ⭐ 387 | 🐛 23 | 🌐 Python | 📅 2026-08-05 - Pull TrueNAS Scale and Core stats, datasets, virtual machines, and apps into sensors and switches (370★).
* [Unraid](https://github.com/ruaan-deysel/ha-unraid) ⭐ 253 | 🐛 9 | 🌐 Python | 📅 2026-09-07 - Monitors and controls an Unraid NAS, including CPU, memory, disks, virtual machines, and Docker containers (240★).
...
* [Bubble Card](https://github.com/Clooos/Bubble-Card) ⭐ 4,556 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-04 - Minimalist card collection with a pop-up touch and rich customization (4,323★).
* [UI Lovelace Minimalist](https://github.com/UI-Lovelace-Minimalist/UI) ⭐ 2,062 | 🐛 43 | 🌐 JavaScript | 📅 2026-09-07 - Drop-in dashboard collection with a uniform minimalist look across all your views, including ready-made cards and a button card library (2,036★).
* [Floorplan](https://github.com/ExperienceLovelace/ha-floorplan) ⭐ 1,604 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-11 - Map entities onto an SVG of your house and animate them based on state changes (1,553★).
...
* [Card Modder](https://github.com/thomasloven/lovelace-card-mod) ⭐ 1,807 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-02 - Style your Lovelace cards (1,722★).
...
* [Vertical Stack In Card](https://github.com/ofekashery/vertical-stack-in-card) ⭐ 981 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-31 - Group multiple cards into a single sleek card with one shared border (968★).
...
* [Paper Buttons Row](https://github.com/jcwillox/lovelace-paper-buttons-row) ⭐ 366 | 🐛 73 | 🌐 TypeScript | 📅 2026-09-12 - Highly configurable button rows that can call actions, fire haptics, and restyle per state (359★).
...
* [Custom Sidebar](https://github.com/elchininet/custom-sidebar) ⭐ 291 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-13 - Personalise the sidebar per user or device, hide pages, reorder them, or restyle the look (278★).
...
* [Mini Graph Card](https://github.com/kalkih/mini-graph-card) ⭐ 3,886 | 🐛 143 | 🌐 JavaScript | 📅 2026-09-12 - A minimalistic sensor graph card (3,830★).
...
* [Scheduler Card](https://github.com/nielsfaber/scheduler-card) ⭐ 1,256 | 🐛 11 | 🌐 TypeScript | 📅 2026-06-30 - Build and edit weekly schedules for any entity right from the dashboard (1,236★).
...
* [Vehicle Status Card](https://github.com/ngocjohn/vehicle-status-card) ⭐ 301 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-05 - Dashboard card showing fuel or charge level, range, doors, lock state, and a customizable image of the car (262★).
* [Entity Progress Card](https://github.com/francois-le-ko4la/lovelace-entity-progress-card) ⭐ 275 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-12 - Progress-bar card for any numeric entity, with thresholds, gradients, and templated icons (257★).
...
* [Horizon Card](https://github.com/rejuvenate/lovelace-horizon-card) ⭐ 678 | 🐛 23 | 🌐 TypeScript | 📅 2026-07-23 - Visualises the position of the Sun over the horizon throughout the day, with sunrise, sunset, and twilight markers (652★).
* [Weather Radar](https://github.com/Makin-Things/weather-radar-card) ⭐ 449 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-12 - Animated rain radar card using the public RainViewer tile service, with country-level and regional zoom (384★).
...
* [Thermostat Card](https://github.com/ciotlosm/lovelace-thermostat-dark-card) ⭐ 745 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-06 - Thermostat control card that looks like a Nest Thermostat (745★).
...
* [Advanced Camera Card](https://github.com/dermotduffy/advanced-camera-card) ⭐ 1,154 | 🐛 128 | 🌐 TypeScript | 📅 2026-09-10 - Comprehensive camera card with timelines, galleries, snapshots, clips, and per-event playback (1,077★).
...
* [Calendar Card Pro](https://github.com/alexpfau/calendar-card-pro) ⭐ 1,209 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-13 - Customizable calendar card with event grouping, location indicators, and a clean modern look (1,122★).
...
* [HA Firemote](https://github.com/PRProd/HA-Firemote) ⭐ 1,053 | 🐛 200 | 📅 2026-03-08 - Virtual remote for Apple TV, Fire TV, Chromecast, Homatics, Shield, onn., Roku, Xiaomi, and more (987★).
* [Universal Remote Card](https://github.com/Nerwyn/universal-remote-card) ⭐ 598 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-06 - Fully customizable virtual remote for any media device, supporting custom buttons and haptics (569★).
* [LG WebOS Remote Control](https://github.com/madmicio/LG-WebOS-Remote-Control) ⭐ 577 | 🐛 99 | 🌐 TypeScript | 📅 2026-05-08 - Remote Control for LG TV WebOS (551★).
...
* [Wall Panel](https://github.com/j-a-n/lovelace-wallpanel) ⭐ 878 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-13 - Wall-panel mode and photo-screensaver for tablets mounted on the wall (842★).
* [Kiosk Mode](https://github.com/NemesisRE/kiosk-mode) ⭐ 793 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-12 - Hide the header, sidebar, and overflow menu for a clean kiosk-style view (738★).

## Dashboards

*Frameworks that replace or extend the default Home Assistant dashboard with a different look and feel.*

* [Dwains Dashboard](https://github.com/dwainscheeren/dwains-lovelace-dashboard) ⭐ 2,067 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-04 - A fully auto-generating dashboard for desktop, tablet and mobile (2,048★).
...
* [Frosted Glass](https://github.com/wessamlauf/homeassistant-frosted-glass-themes) ⭐ 997 | 🐛 35 | 📅 2026-08-26 - Modern frosted-glass dark and light themes with translucent cards (907★).
...
* [LCARS](https://github.com/th3jesta/ha-lcars) ⭐ 573 | 🐛 14 | 🌐 Python | 📅 2026-09-12 - Star Trek LCARS-inspired theme for the bridge feel (534★).
* [Catppuccin](https://github.com/catppuccin/home-assistant) ⭐ 500 | 🐛 10 | 📅 2026-09-11 - Soothing pastel theme matching the popular Catppuccin palette across editors and apps (427★).
...
* [visionOS](https://github.com/Nezz/homeassistant-visionos-theme) ⭐ 353 | 🐛 12 | 📅 2026-07-25 - Theme inspired by Apple's visionOS (313★).
...
* [DuckDNS](https://github.com/home-assistant/hassio-addons/blob/master/duckdns/DOCS.md) ⭐ 2,221 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Updates your Duck DNS IP address and generates SSL using Let's Encrypt.
* [File editor](https://github.com/home-assistant/hassio-addons/blob/master/configurator/DOCS.md) ⭐ 2,221 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Browser-based configuration file editor.
* [Mosquitto](https://github.com/home-assistant/hassio-addons/blob/master/mosquitto/DOCS.md) ⭐ 2,221 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Fast and reliable MQTT broker.
* [Terminal & SSH](https://github.com/home-assistant/hassio-addons/blob/master/ssh/DOCS.md) ⭐ 2,221 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Allows logging in remotely using a web terminal or SSH client.
* [Samba](https://github.com/home-assistant/hassio-addons/blob/master/samba/DOCS.md) ⭐ 2,221 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Access your configuration files using Windows network shares.
* [NGINX SSL proxy](https://github.com/home-assistant/hassio-addons/blob/master/nginx_proxy/DOCS.md) ⭐ 2,221 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Reverse proxy with SSL termination.
* [deCONZ](https://github.com/home-assistant/hassio-addons/blob/master/deconz/DOCS.md) ⭐ 2,221 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Control a ZigBee network using ConBee or RaspBee hardware by Dresden Elektronik.
* [Let's Encrypt](https://github.com/home-assistant/hassio-addons/blob/master/letsencrypt/DOCS.md) ⭐ 2,221 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - Get a free SSL certificate from Let's Encrypt; an open and automated certificate authority (CA).
* [MariaDB](https://github.com/home-assistant/hassio-addons/blob/master/mariadb/DOCS.md) ⭐ 2,221 | 🐛 69 | 🌐 Shell | 📅 2026-09-10 - An open source relational database (fork of MySQL).

### 📦 Third Party Apps

*Anyone can create an app, the following are created by the community.*

* [zigbee2mqtt](https://github.com/Koenkk/zigbee2mqtt) ⭐ 15,631 | 🐛 457 | 🌐 TypeScript | 📅 2026-09-12 - Zigbee to MQTT bridge, get rid of your proprietary Zigbee bridges (15,213★).
...
* [Glances](https://github.com/hassio-addons/app-glances) ⭐ 187 | 🐛 6 | 🌐 Shell | 📅 2026-09-11 - A cross-platform system monitoring tool written in Python (186★).
...
* [Tasmota](https://github.com/arendst/Tasmota) ⭐ 24,757 | 🐛 16 | 🌐 C | 📅 2026-09-12 - Firmware for ESP8266 boards and devices (24,475★).
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,093 | 🐛 49 | 🌐 C++ | 📅 2026-09-13 - A flexible MQTT gateway for IR, RF, BLE, MiFlora, SMS, and many sensors (4,023★).
...
* [Node-RED](https://github.com/node-red/node-red) ⭐ 23,650 | 🐛 334 | 🌐 JavaScript | 📅 2026-09-09 - Flow-based visual programming tool for wiring together devices, APIs, and services, backed by the OpenJS Foundation (23,277★).
* [Domoticz](https://github.com/domoticz/domoticz) ⭐ 3,801 | 🐛 22 | 🌐 C++ | 📅 2026-09-10 - A lightweight Home Automation System (3,773★).
* [Gladys](https://github.com/GladysAssistant/Gladys) ⭐ 3,189 | 🐛 54 | 🌐 JavaScript | 📅 2026-09-07 - Open source program which runs on your Raspberry Pi (3,066★).
...
* [Jeedom](https://github.com/jeedom/core) ⭐ 414 | 🐛 54 | 🌐 PHP | 📅 2026-09-13 - French-origin, cloudless platform with a plugin marketplace, running on any Linux system (414★).
...
* [awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 318,899 | 🐛 0 | 📅 2026-09-12 - Curated list of awesome self hosted software (298,647★).
...
* [awesome-mqtt](https://github.com/awesome-mqtt/awesome-mqtt#readme) ⭐ 2,396 | 🐛 0 | 📅 2026-09-01 - Curated list of MQTT related stuff (2,350★).

## Contributing

This awesome list is an active open-source project and is always open to
people who want to contribute to it. We have set up a separate document
containing our [Contribution Guidelines](https://github.com/frenck/awesome-home-assistant/blob/main/.github/CONTRIBUTING.md) ⭐ 8,440 | 🐛 22 | 🌐 Python | 📅 2026-09-11.
...
[contributor's page](https://github.com/frenck/awesome-home-assistant/graphs/contributors) ⭐ 8,440 | 🐛 22 | 🌐 Python | 📅 2026-09-11.
